...
class rice::Continuation_MultiContinuation_getSubContinuation_1
...
public:
    ...
    // Generated
    Continuation_MultiContinuation_getSubContinuation_1(Continuation_MultiContinuation *Continuation_MultiContinuation_this, int32_t index);
    static ::java::lang::Class *class_();
    Continuation_MultiContinuation *Continuation_MultiContinuation_this;
    int32_t index;
