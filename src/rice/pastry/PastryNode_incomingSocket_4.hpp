...
class rice::pastry::PastryNode_incomingSocket_4
...
public:
    ...
    // Generated
    PastryNode_incomingSocket_4(PastryNode *PastryNode_this, ::java::nio::ByteBuffer* appIdBuffer);
    static ::java::lang::Class *class_();
    PastryNode *PastryNode_this;
    ::java::nio::ByteBuffer* appIdBuffer;
