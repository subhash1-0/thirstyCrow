...
class rice::pastry::socket::SocketPastryNodeFactory_getSocketCountListener_1
    : public virtual ::java::lang::Object
    , public virtual ::org::mpisws::p2p::transport::SocketCountListener
{

public:
    typedef ::java::lang::Object super;
    virtual void socketOpened(::java::net::InetSocketAddress* i, ::java::util::Map* options, bool outgoing);
    virtual void socketClosed(::java::net::InetSocketAddress* i, ::java::util::Map* options);

    // Generated
    SocketPastryNodeFactory_getSocketCountListener_1(SocketPastryNodeFactory *SocketPastryNodeFactory_this, ::rice::pastry::PastryNode* pn);
    static ::java::lang::Class *class_();
    virtual void socketClosed(::java::lang::Object* i, ::java::util::Map* options) override;
    virtual void socketOpened(::java::lang::Object* i, ::java::util::Map* options, bool outgoing) override;
