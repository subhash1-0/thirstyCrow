...
class rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalAddressHelper_5_receiveException_5_2
...
public:
    ...
    // Generated
    ConnectivityVerifierImpl_findExternalAddressHelper_5_receiveException_5_2(ConnectivityVerifierImpl_findExternalAddressHelper_5 *ConnectivityVerifierImpl_findExternalAddressHelper_5_this, ::rice::Continuation* deliverResultToMe, ::java::io::IOException* exception);
