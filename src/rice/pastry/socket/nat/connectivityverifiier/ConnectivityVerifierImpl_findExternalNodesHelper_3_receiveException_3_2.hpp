...
class rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalNodesHelper_3_receiveException_3_2
...
public:
    ...
    // Generated
    ConnectivityVerifierImpl_findExternalNodesHelper_3_receiveException_3_2(ConnectivityVerifierImpl_findExternalNodesHelper_3 *ConnectivityVerifierImpl_findExternalNodesHelper_3_this, ::rice::Continuation* deliverResultToMe, ::java::io::IOException* exception);
