...
class rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalNodes_2
...
public:
    ...
    // Generated
    ConnectivityVerifierImpl_findExternalNodes_2(ConnectivityVerifierImpl *ConnectivityVerifierImpl_this, ::rice::p2p::util::AttachableCancellable* ret, ::java::net::InetSocketAddress* local, ::java::util::ArrayList* probeList, ::rice::Continuation* deliverResultToMe, ::java::util::Collection* probeAddresses);
