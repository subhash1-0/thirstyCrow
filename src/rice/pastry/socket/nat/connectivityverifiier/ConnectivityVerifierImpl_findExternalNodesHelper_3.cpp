...
void rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalNodesHelper_3::receiveResult(::java::util::Collection* result)
{
    if(npc(ConnectivityVerifierImpl_this->logger)->level <= ::rice::environment::logging::Logger::INFO)
        npc(ConnectivityVerifierImpl_this->logger)->log(::java::lang::StringBuilder().append(u"findExternalNodesHelper("_j)->append(static_cast< ::java::lang::Object* >(lookup))
            ->append(u","_j)
    ...
    npc(ret)->cancel();
    npc(lookup)->destroy();
    npc(npc(ConnectivityVerifierImpl_this->environment)->getSelectorManager())->invoke(new ConnectivityVerifierImpl_findExternalNodesHelper_3_receiveResult_3_1(this, deliverResultToMe, result));
}

void rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalNodesHelper_3::receiveResult(::java::lang::Object* result)
{ 
    receiveResult(dynamic_cast< ::java::util::Collection* >(result));
}

void rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalNodesHelper_3::receiveException(::java::io::IOException* exception)
{
    if(npc(ConnectivityVerifierImpl_this->logger)->level <= ::rice::environment::logging::Logger::INFO)
        npc(ConnectivityVerifierImpl_this->logger)->log(::java::lang::StringBuilder().append(u"findExternalNodesHelper("_j)->append(static_cast< ::java::lang::Object* >(lookup))
            ->append(u","_j)
    ...
    if(npc(probeList)->isEmpty()) {
        npc(lookup)->destroy();
        npc(npc(ConnectivityVerifierImpl_this->environment)->getSelectorManager())->invoke(new ConnectivityVerifierImpl_findExternalNodesHelper_3_receiveException_3_2(this, deliverResultToMe, exception));
        return;
    }
    ConnectivityVerifierImpl_this->findExternalNodesHelper(lookup, ret, local, probeList, deliverResultToMe);
}

void rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalNodesHelper_3::receiveException(::java::lang::Exception* exception)
{ 
...
java::lang::Class* rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalNodesHelper_3::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalNodesHelper_3::getClass0()
{
    return class_();
}
