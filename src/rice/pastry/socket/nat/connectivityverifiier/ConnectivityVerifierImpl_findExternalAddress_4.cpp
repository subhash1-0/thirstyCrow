...
rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalAddress_4::ConnectivityVerifierImpl_findExternalAddress_4(ConnectivityVerifierImpl *ConnectivityVerifierImpl_this, ::rice::p2p::util::AttachableCancellable* ret, ::java::net::InetSocketAddress* local, ::java::util::ArrayList* probeList, ::rice::Continuation* deliverResultToMe, ::java::util::Collection* probeAddresses)
...
void rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalAddress_4::receiveResult(::org::mpisws::p2p::transport::networkinfo::InetSocketAddressLookup* lookup)
{
    ConnectivityVerifierImpl_this->findExternalAddressHelper(lookup, ret, local, probeList, deliverResultToMe);
}

void rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalAddress_4::receiveResult(::java::lang::Object* result)
{ 
    receiveResult(dynamic_cast< ::org::mpisws::p2p::transport::networkinfo::InetSocketAddressLookup* >(result));
}

void rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalAddress_4::receiveException(::java::io::IOException* exception)
{
...
void rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalAddress_4::receiveException(::java::lang::Exception* exception)
{ 
...
java::lang::Class* rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalAddress_4::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* rice::pastry::socket::nat::connectivityverifiier::ConnectivityVerifierImpl_findExternalAddress_4::getClass0()
{
    return class_();
}
