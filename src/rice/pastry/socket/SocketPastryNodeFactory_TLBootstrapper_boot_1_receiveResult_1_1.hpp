...
class rice::pastry::socket::SocketPastryNodeFactory_TLBootstrapper_boot_1_receiveResult_1_1
...
public:
    ...
    // Generated
    SocketPastryNodeFactory_TLBootstrapper_boot_1_receiveResult_1_1(SocketPastryNodeFactory_TLBootstrapper_boot_1 *SocketPastryNodeFactory_TLBootstrapper_boot_1_this, bool seed, ::java::util::Collection* bootaddresses);
    static ::java::lang::Class *class_();
    virtual void receiveResult(::java::lang::Object* result) override;
    SocketPastryNodeFactory_TLBootstrapper_boot_1 *SocketPastryNodeFactory_TLBootstrapper_boot_1_this;
    bool seed;
