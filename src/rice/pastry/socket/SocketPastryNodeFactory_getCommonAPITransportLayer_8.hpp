...
class rice::pastry::socket::SocketPastryNodeFactory_getCommonAPITransportLayer_8
    : public virtual ::java::lang::Object
    , public virtual ::org::mpisws::p2p::transport::commonapi::IdFactory
{

public:
    typedef ::java::lang::Object super;
    ::rice::p2p::commonapi::Id* build(::rice::p2p::commonapi::rawserialization::InputBuffer* buf) /* throws(IOException) */ override;

    // Generated
    SocketPastryNodeFactory_getCommonAPITransportLayer_8(SocketPastryNodeFactory *SocketPastryNodeFactory_this);
