...
class rice::pastry::socket::SocketPastryNodeFactory_getIdentityImpl_3
    : public virtual ::java::lang::Object
    , public virtual ::org::mpisws::p2p::transport::identity::NodeChangeStrategy
{

public:
    typedef ::java::lang::Object super;
    virtual bool canChange(TransportLayerNodeHandle* oldDest, TransportLayerNodeHandle* newDest);

    // Generated
    SocketPastryNodeFactory_getIdentityImpl_3(SocketPastryNodeFactory *SocketPastryNodeFactory_this);
    static ::java::lang::Class *class_();
    virtual bool canChange(::java::lang::Object* oldDest, ::java::lang::Object* newDest) override;
