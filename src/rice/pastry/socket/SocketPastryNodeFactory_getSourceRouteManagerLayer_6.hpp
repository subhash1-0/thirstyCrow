...
class rice::pastry::socket::SocketPastryNodeFactory_getSourceRouteManagerLayer_6
...
public:
    ...
    // Generated
    SocketPastryNodeFactory_getSourceRouteManagerLayer_6(SocketPastryNodeFactory *SocketPastryNodeFactory_this, ::org::mpisws::p2p::transport::sourceroute::manager::SourceRouteManager* srm);
    static ::java::lang::Class *class_();
    SocketPastryNodeFactory *SocketPastryNodeFactory_this;
    ::org::mpisws::p2p::transport::sourceroute::manager::SourceRouteManager* srm;
