...
class rice::pastry::socket::SocketPastryNodeFactory_newNode_11_run_11_1
...
public:
    ...
    virtual void receiveResult(::rice::pastry::PastryNode* node);
    virtual void receiveException(::java::io::IOException* exception);

    // Generated
    SocketPastryNodeFactory_newNode_11_run_11_1(SocketPastryNodeFactory_newNode_11 *SocketPastryNodeFactory_newNode_11_this, ::java::util::ArrayList* pn, ::java::util::ArrayList* re);
    ...
    SocketPastryNodeFactory_newNode_11 *SocketPastryNodeFactory_newNode_11_this;
