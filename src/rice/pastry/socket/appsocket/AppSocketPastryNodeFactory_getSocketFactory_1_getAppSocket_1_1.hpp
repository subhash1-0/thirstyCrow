...
class rice::pastry::socket::appsocket::AppSocketPastryNodeFactory_getSocketFactory_1_getAppSocket_1_1
...
public:
    ...
    // Generated
    AppSocketPastryNodeFactory_getSocketFactory_1_getAppSocket_1_1(AppSocketPastryNodeFactory_getSocketFactory_1 *AppSocketPastryNodeFactory_getSocketFactory_1_this, ::rice::Continuation* c);
