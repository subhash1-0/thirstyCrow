...
class rice::pastry::socket::appsocket::AppSocketPastryNodeFactory_getSocketFactory_1_getSocketChannel_1_2
...
public:
    ...
    // Generated
    AppSocketPastryNodeFactory_getSocketFactory_1_getSocketChannel_1_2(AppSocketPastryNodeFactory_getSocketFactory_1 *AppSocketPastryNodeFactory_getSocketFactory_1_this, ::rice::Continuation* c, int32_t myUid);
