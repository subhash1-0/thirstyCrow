...
class rice::pastry::socket::SocketPastryNodeFactory_TLBootstrapper_boot_3
...
public:
    ...
    // Generated
    SocketPastryNodeFactory_TLBootstrapper_boot_3(SocketPastryNodeFactory_TLBootstrapper *SocketPastryNodeFactory_TLBootstrapper_this, ::rice::Continuation* beginPns, ::java::util::Collection* bootHandles);
