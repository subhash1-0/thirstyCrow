...
class rice::pastry::standard::StandardJoinProtocol_SJPDeserializer
...
public:
    ...
    // Generated
    StandardJoinProtocol_SJPDeserializer(::rice::pastry::PastryNode* pn);
protected:
    StandardJoinProtocol_SJPDeserializer(const ::default_init_tag&);
