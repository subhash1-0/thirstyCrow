...
class rice::pastry::client::PastryAppl_LeafSetObserver
...
public:
    ...
    // Generated
    PastryAppl_LeafSetObserver(PastryAppl *PastryAppl_this);
protected:
    PastryAppl_LeafSetObserver(PastryAppl *PastryAppl_this, const ::default_init_tag&);
