...
class rice::pastry::PastryNode_connect_3_run_3_1_receiveResult_3_1_1
...
public:
    ...
    // Generated
    PastryNode_connect_3_run_3_1_receiveResult_3_1_1(PastryNode_connect_3_run_3_1 *PastryNode_connect_3_run_3_1_this, ::java::nio::ByteBuffer* b, ::rice::p2p::commonapi::appsocket::AppSocketReceiver* deliverSocketToMe, ::rice::pastry::client::PastryAppl* appl);
    static ::java::lang::Class *class_();
    PastryNode_connect_3_run_3_1 *PastryNode_connect_3_run_3_1_this;
