...
rice::pastry::pns::PNSApplication_getProximity_9::PNSApplication_getProximity_9(PNSApplication *PNSApplication_this, ::rice::p2p::util::AttachableCancellable* cancellable, ::rice::Continuation* c, ::rice::pastry::NodeHandle* handle)
...
void rice::pastry::pns::PNSApplication_getProximity_9::run()
{
...
java::lang::Class* rice::pastry::pns::PNSApplication_getProximity_9::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* rice::pastry::pns::PNSApplication_getProximity_9::getClass0()
{
    return class_();
}
