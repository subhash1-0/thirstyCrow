...
class rice::pastry::pns::PNSApplication_getNearest_12_receiveResult_12_1
...
public:
    ...
    // Generated
    PNSApplication_getNearest_12_receiveResult_12_1(PNSApplication_getNearest_12 *PNSApplication_getNearest_12_this, ::rice::p2p::util::AttachableCancellable* ret, ::rice::Continuation* retToMe);
    static ::java::lang::Class *class_();
    virtual void receiveResult(::java::lang::Object* result) override;
    PNSApplication_getNearest_12 *PNSApplication_getNearest_12_this;
