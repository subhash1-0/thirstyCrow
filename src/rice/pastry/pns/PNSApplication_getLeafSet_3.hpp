...
class rice::pastry::pns::PNSApplication_getLeafSet_3
...
public:
    ...
    // Generated
    PNSApplication_getLeafSet_3(PNSApplication *PNSApplication_this, ::rice::p2p::util::AttachableCancellable* cancellable, ::rice::Continuation* c, ::rice::pastry::NodeHandle* handle);
