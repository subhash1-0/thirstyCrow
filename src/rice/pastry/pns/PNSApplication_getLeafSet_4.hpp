...
class rice::pastry::pns::PNSApplication_getLeafSet_4
...
public:
    ...
    // Generated
    PNSApplication_getLeafSet_4(PNSApplication *PNSApplication_this, ::rice::p2p::util::AttachableCancellable* cancellable, ::rice::Continuation* c);
