...
class rice::pastry::pns::PNSApplication_getRouteRow_5
...
public:
    ...
    // Generated
    PNSApplication_getRouteRow_5(PNSApplication *PNSApplication_this, ::rice::pastry::NodeHandle* handle, int16_t row, ::rice::Continuation* c);
