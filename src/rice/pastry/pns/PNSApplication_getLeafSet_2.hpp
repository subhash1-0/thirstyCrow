...
class rice::pastry::pns::PNSApplication_getLeafSet_2
...
public:
    ...
    // Generated
    PNSApplication_getLeafSet_2(PNSApplication *PNSApplication_this, ::rice::pastry::NodeHandle* handle, ::rice::Continuation* c);
