...
class rice::pastry::pns::PNSApplication_getProximity_9
...
public:
    ...
    // Generated
    PNSApplication_getProximity_9(PNSApplication *PNSApplication_this, ::rice::p2p::util::AttachableCancellable* cancellable, ::rice::Continuation* c, ::rice::pastry::NodeHandle* handle);
