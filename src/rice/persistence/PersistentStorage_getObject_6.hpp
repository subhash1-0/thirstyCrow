...
class rice::persistence::PersistentStorage_getObject_6
...
public:
    ...
    // Generated
    PersistentStorage_getObject_6(PersistentStorage *PersistentStorage_this, ::rice::p2p::commonapi::Id* id, ::rice::Continuation* c, ::rice::selector::SelectorManager* sm);
    PersistentStorage_getObject_6(PersistentStorage *PersistentStorage_this, ::rice::p2p::commonapi::Id* id);
