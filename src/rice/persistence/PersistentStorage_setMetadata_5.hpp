...
class rice::persistence::PersistentStorage_setMetadata_5
...
public:
    ...
    // Generated
    PersistentStorage_setMetadata_5(PersistentStorage *PersistentStorage_this, ::rice::p2p::commonapi::Id* id, ::java::io::Serializable* metadata, ::rice::Continuation* c, ::rice::selector::SelectorManager* sm);
    PersistentStorage_setMetadata_5(PersistentStorage *PersistentStorage_this, ::rice::p2p::commonapi::Id* id, ::java::io::Serializable* metadata);
