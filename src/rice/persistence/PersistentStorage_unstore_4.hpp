...
class rice::persistence::PersistentStorage_unstore_4
...
public:
    ...
    // Generated
    PersistentStorage_unstore_4(PersistentStorage *PersistentStorage_this, ::rice::p2p::commonapi::Id* id, ::rice::Continuation* c, ::rice::selector::SelectorManager* sm);
    PersistentStorage_unstore_4(PersistentStorage *PersistentStorage_this, ::rice::p2p::commonapi::Id* id);
