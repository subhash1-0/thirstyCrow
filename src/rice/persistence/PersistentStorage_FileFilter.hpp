...
class rice::persistence::PersistentStorage_FileFilter
...
public:
    ...
    // Generated
    PersistentStorage_FileFilter(PersistentStorage *PersistentStorage_this);
protected:
    PersistentStorage_FileFilter(PersistentStorage *PersistentStorage_this, const ::default_init_tag&);
