...
class rice::persistence::PersistentStorage_flush_7
...
public:
    ...
    // Generated
    PersistentStorage_flush_7(PersistentStorage *PersistentStorage_this, ::rice::Continuation* c, ::rice::selector::SelectorManager* sm);
    PersistentStorage_flush_7(PersistentStorage *PersistentStorage_this);
