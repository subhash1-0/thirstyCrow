...
class rice::persistence::testing::MemoryStorageTest_testRandomInserts_22
...
public:
    ...
    // Generated
    MemoryStorageTest_testRandomInserts_22(MemoryStorageTest *MemoryStorageTest_this, int32_t START_NUM, int32_t END_NUM, int32_t SKIP, ::rice::Continuation* checkScan);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    int32_t START_NUM;
    int32_t END_NUM;
    int32_t SKIP;
    ::rice::Continuation* checkScan;
