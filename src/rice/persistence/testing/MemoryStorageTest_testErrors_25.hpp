...
class rice::persistence::testing::MemoryStorageTest_testErrors_25
...
public:
    ...
    // Generated
    MemoryStorageTest_testErrors_25(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* validateNullValue);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* validateNullValue;
