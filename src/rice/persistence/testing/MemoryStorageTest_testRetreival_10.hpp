...
class rice::persistence::testing::MemoryStorageTest_testRetreival_10
...
public:
    ...
    // Generated
    MemoryStorageTest_testRetreival_10(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* get1);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* get1;
