...
class rice::persistence::testing::MemoryStorageTest_testRemoval_15
...
public:
    ...
    // Generated
    MemoryStorageTest_testRemoval_15(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* check1);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* check1;
