...
class rice::persistence::testing::MemoryStorageTest_testRandomInserts_20
...
public:
    ...
    // Generated
    MemoryStorageTest_testRandomInserts_20(MemoryStorageTest *MemoryStorageTest_this, int32_t START_NUM, int32_t END_NUM, ::rice::Continuation* checkRandom, int32_t SKIP);
