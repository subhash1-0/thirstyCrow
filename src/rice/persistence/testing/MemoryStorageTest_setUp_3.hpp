...
class rice::persistence::testing::MemoryStorageTest_setUp_3
...
public:
    ...
    // Generated
    MemoryStorageTest_setUp_3(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* put3);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* put3;
