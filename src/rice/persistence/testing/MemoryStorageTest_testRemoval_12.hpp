...
class rice::persistence::testing::MemoryStorageTest_testRemoval_12
...
public:
    ...
    // Generated
    MemoryStorageTest_testRemoval_12(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* c);
