...
class rice::persistence::testing::LRUCacheTest_testRandomInserts_11
...
public:
    ...
    // Generated
    LRUCacheTest_testRandomInserts_11(LRUCacheTest *LRUCacheTest_this, int32_t START_NUM, int32_t SKIP, int32_t END_NUM, int32_t LAST_NUM_REMAINING, ::rice::Continuation* removeRandom);
