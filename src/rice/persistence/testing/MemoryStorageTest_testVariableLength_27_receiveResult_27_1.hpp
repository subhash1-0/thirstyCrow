...
class rice::persistence::testing::MemoryStorageTest_testVariableLength_27_receiveResult_27_1
...
public:
    ...
    // Generated
    MemoryStorageTest_testVariableLength_27_receiveResult_27_1(MemoryStorageTest_testVariableLength_27 *MemoryStorageTest_testVariableLength_27_this, ::java::util::HashSet* all, ::java::util::HashSet* tmp);
    static ::java::lang::Class *class_();

private:
    void init();
    MemoryStorageTest_testVariableLength_27 *MemoryStorageTest_testVariableLength_27_this;
