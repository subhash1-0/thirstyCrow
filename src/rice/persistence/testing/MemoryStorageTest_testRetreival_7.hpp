...
class rice::persistence::testing::MemoryStorageTest_testRetreival_7
...
public:
    ...
    // Generated
    MemoryStorageTest_testRetreival_7(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* get4);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* get4;
