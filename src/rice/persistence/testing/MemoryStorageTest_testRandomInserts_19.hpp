...
class rice::persistence::testing::MemoryStorageTest_testRandomInserts_19
...
public:
    ...
    // Generated
    MemoryStorageTest_testRandomInserts_19(MemoryStorageTest *MemoryStorageTest_this, int32_t START_NUM, int32_t END_NUM, int32_t SKIP, int32_t NUM_ELEMENTS, ::rice::Continuation* c);
