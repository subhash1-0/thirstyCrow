...
class rice::persistence::testing::LRUCacheTest_testRandomInserts_13
...
public:
    ...
    // Generated
    LRUCacheTest_testRandomInserts_13(LRUCacheTest *LRUCacheTest_this, ::rice::Continuation* insert);
    static ::java::lang::Class *class_();
    LRUCacheTest *LRUCacheTest_this;
    ::rice::Continuation* insert;
