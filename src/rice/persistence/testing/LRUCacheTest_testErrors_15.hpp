...
class rice::persistence::testing::LRUCacheTest_testErrors_15
...
public:
    ...
    // Generated
    LRUCacheTest_testErrors_15(LRUCacheTest *LRUCacheTest_this, ::rice::Continuation* validateNullValue);
