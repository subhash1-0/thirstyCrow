...
class rice::persistence::testing::MemoryStorageTest_testRetreival_5
...
public:
    ...
    // Generated
    MemoryStorageTest_testRetreival_5(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* c);
