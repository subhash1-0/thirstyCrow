...
class rice::persistence::testing::LRUCacheTest_testRandomInserts_12
...
public:
    ...
    // Generated
    LRUCacheTest_testRandomInserts_12(LRUCacheTest *LRUCacheTest_this, int32_t START_NUM, int32_t END_NUM, ::rice::Continuation* checkExists, int32_t SKIP);
