...
class rice::persistence::testing::MemoryStorageTest_testRetreival_9
...
public:
    ...
    // Generated
    MemoryStorageTest_testRetreival_9(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* get2);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* get2;
