...
class rice::persistence::testing::MemoryStorageTest_testErrors_26
...
public:
    ...
    // Generated
    MemoryStorageTest_testErrors_26(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* insertNullValue);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* insertNullValue;
