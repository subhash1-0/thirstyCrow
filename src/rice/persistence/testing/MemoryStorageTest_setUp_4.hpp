...
class rice::persistence::testing::MemoryStorageTest_setUp_4
...
public:
    ...
    // Generated
    MemoryStorageTest_setUp_4(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* put2);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* put2;
