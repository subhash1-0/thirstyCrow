...
class rice::persistence::testing::MemoryStorageTest_testScan_17
...
public:
    ...
    // Generated
    MemoryStorageTest_testScan_17(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* handleBadScan);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* handleBadScan;
