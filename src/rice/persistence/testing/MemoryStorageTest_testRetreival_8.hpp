...
class rice::persistence::testing::MemoryStorageTest_testRetreival_8
...
public:
    ...
    // Generated
    MemoryStorageTest_testRetreival_8(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* get3);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* get3;
