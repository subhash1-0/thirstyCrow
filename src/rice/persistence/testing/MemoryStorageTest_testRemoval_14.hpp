...
class rice::persistence::testing::MemoryStorageTest_testRemoval_14
...
public:
    ...
    // Generated
    MemoryStorageTest_testRemoval_14(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* done1);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* done1;
