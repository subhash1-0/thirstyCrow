...
class rice::persistence::testing::LRUCacheTest_testRandomInserts_9
...
public:
    ...
    // Generated
    LRUCacheTest_testRandomInserts_9(LRUCacheTest *LRUCacheTest_this, int32_t START_NUM, int32_t END_NUM, int32_t SKIP, int32_t NUM_ELEMENTS, ::rice::Continuation* c);
