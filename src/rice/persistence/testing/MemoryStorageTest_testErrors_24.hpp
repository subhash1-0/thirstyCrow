...
class rice::persistence::testing::MemoryStorageTest_testErrors_24
...
public:
    ...
    // Generated
    MemoryStorageTest_testErrors_24(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* c);
