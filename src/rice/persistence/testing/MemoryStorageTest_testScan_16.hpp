...
class rice::persistence::testing::MemoryStorageTest_testScan_16
...
public:
    ...
    // Generated
    MemoryStorageTest_testScan_16(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* c);
