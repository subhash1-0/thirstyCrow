...
class rice::persistence::testing::MemoryStorageTest_testScan_18
...
public:
    ...
    // Generated
    MemoryStorageTest_testScan_18(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* query);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* query;
