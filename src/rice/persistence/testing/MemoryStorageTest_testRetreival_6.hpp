...
class rice::persistence::testing::MemoryStorageTest_testRetreival_6
...
public:
    ...
    // Generated
    MemoryStorageTest_testRetreival_6(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* get5);
    static ::java::lang::Class *class_();
    MemoryStorageTest *MemoryStorageTest_this;
    ::rice::Continuation* get5;
