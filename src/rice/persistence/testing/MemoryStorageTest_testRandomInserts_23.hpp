...
class rice::persistence::testing::MemoryStorageTest_testRandomInserts_23
...
public:
    ...
    // Generated
    MemoryStorageTest_testRandomInserts_23(MemoryStorageTest *MemoryStorageTest_this, int32_t START_NUM, int32_t END_NUM, ::rice::Continuation* checkExists, int32_t SKIP);
