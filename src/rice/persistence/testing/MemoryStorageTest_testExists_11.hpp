...
class rice::persistence::testing::MemoryStorageTest_testExists_11
...
public:
    ...
    // Generated
    MemoryStorageTest_testExists_11(MemoryStorageTest *MemoryStorageTest_this, ::rice::Continuation* c);
