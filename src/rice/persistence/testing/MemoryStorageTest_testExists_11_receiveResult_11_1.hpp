...
class rice::persistence::testing::MemoryStorageTest_testExists_11_receiveResult_11_1
...
public:
    ...
    // Generated
    MemoryStorageTest_testExists_11_receiveResult_11_1(MemoryStorageTest_testExists_11 *MemoryStorageTest_testExists_11_this, ::rice::Continuation* c);
    static ::java::lang::Class *class_();
    MemoryStorageTest_testExists_11 *MemoryStorageTest_testExists_11_this;
    ::rice::Continuation* c;
