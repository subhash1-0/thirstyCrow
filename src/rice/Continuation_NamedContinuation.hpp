...
class rice::Continuation_NamedContinuation
...
protected:
    void ctor(::java::lang::String* name, Continuation* command);
...
public:
    ...
    // Generated
    Continuation_NamedContinuation(::java::lang::String* name, Continuation* command);
protected:
    Continuation_NamedContinuation(const ::default_init_tag&);
