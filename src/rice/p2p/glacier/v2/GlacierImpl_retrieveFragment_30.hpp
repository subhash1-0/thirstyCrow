...
class rice::p2p::glacier::v2::GlacierImpl_retrieveFragment_30
...
public:
    ...
    // Generated
    GlacierImpl_retrieveFragment_30(GlacierImpl *GlacierImpl_this, ::rice::p2p::glacier::FragmentKey* key, ::rice::Continuation* c2);
    static ::java::lang::Class *class_();
    GlacierImpl *GlacierImpl_this;
    ::rice::p2p::glacier::FragmentKey* key;
    ::rice::Continuation* c2;
