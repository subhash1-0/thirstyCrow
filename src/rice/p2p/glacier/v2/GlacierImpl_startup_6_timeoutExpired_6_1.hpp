...
class rice::p2p::glacier::v2::GlacierImpl_startup_6_timeoutExpired_6_1
...
public:
    ...
    // Generated
    GlacierImpl_startup_6_timeoutExpired_6_1(GlacierImpl_startup_6 *GlacierImpl_startup_6_this, ::rice::p2p::glacier::VersionKey* thisVKey, ::rice::p2p::commonapi::IdSet* fragments);
    static ::java::lang::Class *class_();
    GlacierImpl_startup_6 *GlacierImpl_startup_6_this;
    ::rice::p2p::glacier::VersionKey* thisVKey;
    ::rice::p2p::commonapi::IdSet* fragments;
