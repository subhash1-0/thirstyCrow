...
class rice::p2p::glacier::v2::GlacierImpl_handleDebugCommand_13
...
public:
    ...
    // Generated
    GlacierImpl_handleDebugCommand_13(GlacierImpl *GlacierImpl_this, ::rice::p2p::commonapi::Id* randomID, int32_t lifetime);
    static ::java::lang::Class *class_();
    GlacierImpl *GlacierImpl_this;
    ::rice::p2p::commonapi::Id* randomID;
    int32_t lifetime;
