...
class rice::p2p::glacier::v2::GlacierImpl_startup_3_receiveResult_3_1
...
public:
    ...
    // Generated
    GlacierImpl_startup_3_receiveResult_3_1(GlacierImpl_startup_3 *GlacierImpl_startup_3_this, ::rice::p2p::commonapi::IdSet* keySet, ::rice::p2p::commonapi::IdRange* originalRange);
    static ::java::lang::Class *class_();
    GlacierImpl_startup_3 *GlacierImpl_startup_3_this;
    ::rice::p2p::commonapi::IdSet* keySet;
    ::rice::p2p::commonapi::IdRange* originalRange;
