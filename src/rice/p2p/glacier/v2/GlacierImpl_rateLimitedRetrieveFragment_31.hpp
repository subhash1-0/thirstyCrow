...
class rice::p2p::glacier::v2::GlacierImpl_rateLimitedRetrieveFragment_31
...
public:
    ...
    // Generated
    GlacierImpl_rateLimitedRetrieveFragment_31(GlacierImpl *GlacierImpl_this, ::rice::p2p::glacier::FragmentKey* key, Manifest* manifest, char16_t tag, GlacierContinuation* c);
