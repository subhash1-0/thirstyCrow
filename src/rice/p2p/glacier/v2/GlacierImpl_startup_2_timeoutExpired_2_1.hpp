...
class rice::p2p::glacier::v2::GlacierImpl_startup_2_timeoutExpired_2_1
...
public:
    ...
    // Generated
    GlacierImpl_startup_2_timeoutExpired_2_1(GlacierImpl_startup_2 *GlacierImpl_startup_2_this, ::rice::p2p::commonapi::Id* thisNeighbor, int64_t earliestAcceptableDate);
    static ::java::lang::Class *class_();
    GlacierImpl_startup_2 *GlacierImpl_startup_2_this;
    ::rice::p2p::commonapi::Id* thisNeighbor;
    int64_t earliestAcceptableDate;
