...
class rice::p2p::glacier::v2::GlacierImpl_handleDebugCommand_15
...
public: /* package */
    int32_t receivedSoFar {  };
    static constexpr int32_t total { int32_t(100) };
...
public:
    ...
    // Generated
    GlacierImpl_handleDebugCommand_15(GlacierImpl *GlacierImpl_this, ::rice::p2p::commonapi::Id* fragmentLoc, ::rice::p2p::glacier::FragmentKey* id, ::java::lang::StringArray* ret, int64_t now, ::java::lang::BooleanArray* done);
    static ::java::lang::Class *class_();

private:
    void init();
    GlacierImpl *GlacierImpl_this;
    ::rice::p2p::commonapi::Id* fragmentLoc;
    ::rice::p2p::glacier::FragmentKey* id;
    ::java::lang::StringArray* ret;
    int64_t now;
    ::java::lang::BooleanArray* done;
