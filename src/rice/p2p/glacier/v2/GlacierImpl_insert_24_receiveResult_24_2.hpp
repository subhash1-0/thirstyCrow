...
class rice::p2p::glacier::v2::GlacierImpl_insert_24_receiveResult_24_2
...
public:
    ...
    // Generated
    GlacierImpl_insert_24_receiveResult_24_2(GlacierImpl_insert_24 *GlacierImpl_insert_24_this, ::rice::Continuation* command, ::rice::p2p::glacier::VersionKey* vkey, ::rice::p2p::glacier::FragmentArray* fragments, int64_t expiration);
