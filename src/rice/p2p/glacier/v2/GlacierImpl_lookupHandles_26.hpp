...
class rice::p2p::glacier::v2::GlacierImpl_lookupHandles_26
...
public:
    ...
    // Generated
    GlacierImpl_lookupHandles_26(GlacierImpl *GlacierImpl_this, ::rice::p2p::commonapi::Id* id, ::rice::Continuation* command, int64_t version);
