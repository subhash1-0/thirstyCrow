...
class rice::p2p::glacier::v2::GlacierImpl_startup_2_timeoutExpired_2_1_receiveResult_2_1_1
...
public:
    ...
    // Generated
    GlacierImpl_startup_2_timeoutExpired_2_1_receiveResult_2_1_1(GlacierImpl_startup_2_timeoutExpired_2_1 *GlacierImpl_startup_2_timeoutExpired_2_1_this, ::rice::p2p::commonapi::Id* thisNeighbor);
    static ::java::lang::Class *class_();
    GlacierImpl_startup_2_timeoutExpired_2_1 *GlacierImpl_startup_2_timeoutExpired_2_1_this;
    ::rice::p2p::commonapi::Id* thisNeighbor;
