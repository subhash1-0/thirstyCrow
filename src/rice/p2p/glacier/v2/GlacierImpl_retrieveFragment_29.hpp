...
class rice::p2p::glacier::v2::GlacierImpl_retrieveFragment_29
...
public:
    ...
    // Generated
    GlacierImpl_retrieveFragment_29(GlacierImpl *GlacierImpl_this, Manifest* manifest, ::rice::p2p::glacier::FragmentKey* key, GlacierContinuation* c, char16_t tag);
