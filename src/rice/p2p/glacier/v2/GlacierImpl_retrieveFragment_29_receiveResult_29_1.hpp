...
class rice::p2p::glacier::v2::GlacierImpl_retrieveFragment_29_receiveResult_29_1
...
public:
    ...
    // Generated
    GlacierImpl_retrieveFragment_29_receiveResult_29_1(GlacierImpl_retrieveFragment_29 *GlacierImpl_retrieveFragment_29_this, ::rice::p2p::glacier::FragmentKey* key, Manifest* manifest, GlacierContinuation* c, char16_t tag);
    static ::java::lang::Class *class_();
    GlacierImpl_retrieveFragment_29 *GlacierImpl_retrieveFragment_29_this;
