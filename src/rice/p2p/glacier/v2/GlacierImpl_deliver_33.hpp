...
class rice::p2p::glacier::v2::GlacierImpl_deliver_33
...
public:
    ...
    // Generated
    GlacierImpl_deliver_33(GlacierImpl *GlacierImpl_this, ::java::util::Vector* missing, ::rice::p2p::glacier::v2::messaging::GlacierSyncMessage* gsm, int32_t offset);
    static ::java::lang::Class *class_();

private:
    void init();
    GlacierImpl *GlacierImpl_this;
    ::java::util::Vector* missing;
    ::rice::p2p::glacier::v2::messaging::GlacierSyncMessage* gsm;
    int32_t offset;
