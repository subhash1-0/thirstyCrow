...
class rice::p2p::glacier::v2::GlacierImpl_deliver_32
...
public:
    ...
    // Generated
    GlacierImpl_deliver_32(GlacierImpl *GlacierImpl_this, ::rice::p2p::glacier::v2::messaging::GlacierNeighborRequestMessage* gnrm, ::rice::p2p::commonapi::IdArray* neighbors, ::int64_tArray* lastSeen, int32_t numRequested);
    static ::java::lang::Class *class_();

private:
    void init();
    GlacierImpl *GlacierImpl_this;
    ::rice::p2p::glacier::v2::messaging::GlacierNeighborRequestMessage* gnrm;
