...
class rice::p2p::glacier::v2::GlacierImpl_startup_4_receiveResult_4_1
...
public:
    ...
    // Generated
    GlacierImpl_startup_4_receiveResult_4_1(GlacierImpl_startup_4 *GlacierImpl_startup_4_this, ::rice::p2p::glacier::FragmentKey* thisKey);
