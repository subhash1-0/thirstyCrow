...
class rice::p2p::glacier::v2::GlacierImpl_deliver_36
...
public:
    ...
    // Generated
    GlacierImpl_deliver_36(GlacierImpl *GlacierImpl_this, ::rice::p2p::glacier::FragmentKey* thisKey, ::rice::p2p::glacier::v2::messaging::GlacierDataMessage* gdm, Manifest* thisManifest);
