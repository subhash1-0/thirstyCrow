...
class rice::p2p::glacier::v2::GlacierImpl_handleDebugCommand_19
...
public:
    ...
    // Generated
    GlacierImpl_handleDebugCommand_19(GlacierImpl *GlacierImpl_this, ::rice::p2p::commonapi::Id* fragmentLoc, ::rice::p2p::glacier::FragmentKey* id, ::java::lang::StringArray* ret, int64_t now);
