...
class rice::p2p::glacier::v2::GlacierImpl_handleDebugCommand_12
...
public: /* package */
    ::rice::p2p::commonapi::Id* currentLookup {  };
...
public:
    ...
    // Generated
    GlacierImpl_handleDebugCommand_12(GlacierImpl *GlacierImpl_this, ::java::lang::StringBuffer* result, int64_t now, ::java::util::Iterator* iter, ::java::lang::StringArray* ret);
