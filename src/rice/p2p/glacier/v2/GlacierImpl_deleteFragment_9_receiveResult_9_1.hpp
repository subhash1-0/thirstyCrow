...
class rice::p2p::glacier::v2::GlacierImpl_deleteFragment_9_receiveResult_9_1
...
public:
    ...
    // Generated
    GlacierImpl_deleteFragment_9_receiveResult_9_1(GlacierImpl_deleteFragment_9 *GlacierImpl_deleteFragment_9_this, ::rice::p2p::commonapi::Id* fkey, ::rice::Continuation* command);
    static ::java::lang::Class *class_();
    GlacierImpl_deleteFragment_9 *GlacierImpl_deleteFragment_9_this;
    ::rice::p2p::commonapi::Id* fkey;
