...
class rice::p2p::glacier::v2::GlacierImpl_deliver_35
...
public: /* package */
    ...
    ::rice::p2p::glacier::FragmentArray* fragment {  };
    ManifestArray* manifest {  };
    int32_t numFragments {  }, numManifests {  };

public:
    virtual void returnResponse();
    void receiveResult(::java::lang::Object* o) override;
    virtual void nextLookup();
    void receiveException(::java::lang::Exception* e) override;

    // Generated
    GlacierImpl_deliver_35(GlacierImpl *GlacierImpl_this, ::rice::p2p::glacier::v2::messaging::GlacierFetchMessage* gfm);
    static ::java::lang::Class *class_();

private:
    void init();
    GlacierImpl *GlacierImpl_this;
    ::rice::p2p::glacier::v2::messaging::GlacierFetchMessage* gfm;
