...
class rice::p2p::glacier::v2::GlacierImpl_insert_24
...
public:
    ...
    // Generated
    GlacierImpl_insert_24(GlacierImpl *GlacierImpl_this, ::rice::Continuation* command, ::rice::p2p::glacier::VersionKey* vkey, ::rice::p2p::past::PastContent* obj, int64_t expiration);
