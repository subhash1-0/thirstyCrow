...
class rice::p2p::glacier::v2::GlacierImpl_deleteFragment_9
...
public:
    ...
    // Generated
    GlacierImpl_deleteFragment_9(GlacierImpl *GlacierImpl_this, ::rice::p2p::commonapi::Id* fkey, ::rice::Continuation* command);
