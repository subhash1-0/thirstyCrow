...
class rice::p2p::glacier::v2::GlacierImpl_deliver_37
...
public:
    ...
    // Generated
    GlacierImpl_deliver_37(GlacierImpl *GlacierImpl_this, ::rice::p2p::glacier::FragmentKey* thisKey, Manifest* thisManifest, FragmentMetadata* metadata, ::rice::p2p::glacier::v2::messaging::GlacierDataMessage* gdm);
