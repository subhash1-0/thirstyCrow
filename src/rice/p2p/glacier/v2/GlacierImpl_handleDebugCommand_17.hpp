...
class rice::p2p::glacier::v2::GlacierImpl_handleDebugCommand_17
...
public:
    ...
    // Generated
    GlacierImpl_handleDebugCommand_17(GlacierImpl *GlacierImpl_this, ::java::lang::StringArray* ret, ::rice::p2p::glacier::FragmentKey* id, FragmentMetadata* metadata);
