...
class rice::p2p::glacier::v2::GlacierImpl_deliver_37_receiveResult_37_1
...
public:
    ...
    // Generated
    GlacierImpl_deliver_37_receiveResult_37_1(GlacierImpl_deliver_37 *GlacierImpl_deliver_37_this, ::rice::p2p::glacier::FragmentKey* thisKey, ::rice::p2p::glacier::v2::messaging::GlacierDataMessage* gdm, Manifest* thisManifest);
    static ::java::lang::Class *class_();
    GlacierImpl_deliver_37 *GlacierImpl_deliver_37_this;
    ::rice::p2p::glacier::FragmentKey* thisKey;
    ::rice::p2p::glacier::v2::messaging::GlacierDataMessage* gdm;
