...
class rice::p2p::glacier::v2::GlacierImpl_neighborSeen_25_receiveResult_25_1
...
public:
    ...
    // Generated
    GlacierImpl_neighborSeen_25_receiveResult_25_1(GlacierImpl_neighborSeen_25 *GlacierImpl_neighborSeen_25_this, ::rice::p2p::commonapi::Id* fNodeId, int64_t fWhen, int64_t previousWhen);
    static ::java::lang::Class *class_();
    GlacierImpl_neighborSeen_25 *GlacierImpl_neighborSeen_25_this;
    ::rice::p2p::commonapi::Id* fNodeId;
    int64_t fWhen;
    int64_t previousWhen;
