...
class rice::p2p::glacier::v2::GlacierImpl_neighborSeen_25
...
public:
    ...
    // Generated
    GlacierImpl_neighborSeen_25(GlacierImpl *GlacierImpl_this, ::rice::p2p::commonapi::Id* fNodeId, int64_t fWhen);
