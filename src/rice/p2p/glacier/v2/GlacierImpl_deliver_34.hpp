...
class rice::p2p::glacier::v2::GlacierImpl_deliver_34
...
public: /* package */
    static constexpr int32_t phaseFetch { int32_t(1) };
    static constexpr int32_t phaseStore { int32_t(2) };
    static constexpr int32_t phaseAdvance { int32_t(3) };
...
public:
    ...
    // Generated
    GlacierImpl_deliver_34(GlacierImpl *GlacierImpl_this, ::rice::p2p::glacier::v2::messaging::GlacierRefreshPatchMessage* grpm);
    static ::java::lang::Class *class_();

private:
    void init();
    GlacierImpl *GlacierImpl_this;
    ::rice::p2p::glacier::v2::messaging::GlacierRefreshPatchMessage* grpm;
