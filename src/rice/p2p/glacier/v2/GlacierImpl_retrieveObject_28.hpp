...
class rice::p2p::glacier::v2::GlacierImpl_retrieveObject_28
...
public: /* protected */
    ::boolArray* checkedFragment {  };
    ::rice::p2p::glacier::FragmentArray* haveFragment {  };
    int32_t attemptsLeft {  };
    int64_t timeout {  };

public:
    virtual int32_t numHaveFragments();
    virtual int32_t numCheckedFragments();
...
public:
    ...
    virtual void sendRandomRequest();
    void timeoutExpired() override;
    int64_t getTimeout() override;

    // Generated
    GlacierImpl_retrieveObject_28(GlacierImpl *GlacierImpl_this, ::rice::p2p::glacier::VersionKey* key, Manifest* manifest, ::rice::Continuation* c, char16_t tag, bool beStrict);
