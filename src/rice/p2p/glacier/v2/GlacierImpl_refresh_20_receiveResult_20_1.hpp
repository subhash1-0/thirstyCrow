...
class rice::p2p::glacier::v2::GlacierImpl_refresh_20_receiveResult_20_1
...
public:
    ...
    // Generated
    GlacierImpl_refresh_20_receiveResult_20_1(GlacierImpl_refresh_20 *GlacierImpl_refresh_20_this, ::rice::p2p::commonapi::Id* thisId, int64_t thisVersion, int64_t thisExpiration, ::rice::Continuation* thisContinuation);
    static ::java::lang::Class *class_();
    GlacierImpl_refresh_20 *GlacierImpl_refresh_20_this;
    ::rice::p2p::commonapi::Id* thisId;
    int64_t thisVersion;
    int64_t thisExpiration;
