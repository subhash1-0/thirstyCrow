...
class rice::p2p::glacier::v2::GlacierImpl_deliver_38
...
public:
    ...
    // Generated
    GlacierImpl_deliver_38(GlacierImpl *GlacierImpl_this, ::rice::p2p::glacier::FragmentKey* thisKey, Manifest* thisManifest, int64_t tStart);
