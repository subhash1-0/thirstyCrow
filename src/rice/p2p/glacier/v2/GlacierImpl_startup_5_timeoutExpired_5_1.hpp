...
class rice::p2p::glacier::v2::GlacierImpl_startup_5_timeoutExpired_5_1
...
public:
    ...
    // Generated
    GlacierImpl_startup_5_timeoutExpired_5_1(GlacierImpl_startup_5 *GlacierImpl_startup_5_this, ::rice::p2p::commonapi::Id* thisKey, int64_t now, FragmentMetadata* metadata);
    static ::java::lang::Class *class_();
    GlacierImpl_startup_5 *GlacierImpl_startup_5_this;
    ::rice::p2p::commonapi::Id* thisKey;
    int64_t now;
