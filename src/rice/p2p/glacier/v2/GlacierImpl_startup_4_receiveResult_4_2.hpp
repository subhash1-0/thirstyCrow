...
class rice::p2p::glacier::v2::GlacierImpl_startup_4_receiveResult_4_2
...
public:
    ...
    // Generated
    GlacierImpl_startup_4_receiveResult_4_2(GlacierImpl_startup_4 *GlacierImpl_startup_4_this, ::rice::p2p::glacier::FragmentKey* thisKey, ::rice::p2p::glacier::v2::messaging::GlacierResponseMessage* grm);
    static ::java::lang::Class *class_();
    GlacierImpl_startup_4 *GlacierImpl_startup_4_this;
    ::rice::p2p::glacier::FragmentKey* thisKey;
    ::rice::p2p::glacier::v2::messaging::GlacierResponseMessage* grm;
