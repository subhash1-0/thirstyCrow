...
class rice::p2p::glacier::v2::GlacierImpl_retrieveManifest_27
...
public:
    ...
    // Generated
    GlacierImpl_retrieveManifest_27(GlacierImpl *GlacierImpl_this, ::rice::p2p::glacier::VersionKey* key, char16_t tag, ::rice::Continuation* command);
