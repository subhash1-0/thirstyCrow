...
class rice::p2p::past::testing::RawPastRegrTest_testLookupHandles_7_receive_7_1
...
public: /* protected */
    RawPastRegrTest_testLookupHandles_7_receive_7_1(RawPastRegrTest_testLookupHandles_7 *RawPastRegrTest_testLookupHandles_7_this, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastImpl* local);

public:
    static ::java::lang::Class *class_();
    RawPastRegrTest_testLookupHandles_7 *RawPastRegrTest_testLookupHandles_7_this;
