...
class rice::p2p::past::testing::PastRegrTest_testCaching_6_receive_6_1
...
public: /* protected */
    PastRegrTest_testCaching_6_receive_6_1(PastRegrTest_testCaching_6 *PastRegrTest_testCaching_6_this, ::rice::p2p::past::PastContent* file1, ::rice::p2p::commonapi::Id* id2, ::rice::p2p::past::PastImpl* local, ::rice::p2p::past::PastContent* file2, ::rice::p2p::past::PastContent* file3);

public:
    static ::java::lang::Class *class_();
    PastRegrTest_testCaching_6 *PastRegrTest_testCaching_6_this;
