...
class rice::p2p::past::testing::PastRegrTest_testVersionControl_3
...
public: /* protected */
    PastRegrTest_testVersionControl_3(PastRegrTest *PastRegrTest_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastContent* oldFile, ::rice::p2p::past::PastContent* newFile, ::rice::p2p::past::PastContent* newNewFile);
