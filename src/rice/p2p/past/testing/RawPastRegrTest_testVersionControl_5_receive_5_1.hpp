...
class rice::p2p::past::testing::RawPastRegrTest_testVersionControl_5_receive_5_1
...
public: /* protected */
    RawPastRegrTest_testVersionControl_5_receive_5_1(RawPastRegrTest_testVersionControl_5 *RawPastRegrTest_testVersionControl_5_this, ::rice::p2p::past::PastContent* oldFile, ::rice::p2p::past::PastImpl* local, ::rice::p2p::past::PastContent* newFile, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastContent* newNewFile);

public:
    static ::java::lang::Class *class_();
    RawPastRegrTest_testVersionControl_5 *RawPastRegrTest_testVersionControl_5_this;
    ::rice::p2p::past::PastContent* oldFile;
