...
class rice::p2p::past::testing::RawPastRegrTest_TestExceptionCommand
...
public:
    ...
    // Generated
    RawPastRegrTest_TestExceptionCommand(RawPastRegrTest *RawPastRegrTest_this);
protected:
    RawPastRegrTest_TestExceptionCommand(RawPastRegrTest *RawPastRegrTest_this, const ::default_init_tag&);
