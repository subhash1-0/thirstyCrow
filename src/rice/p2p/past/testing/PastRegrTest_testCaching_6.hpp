...
class rice::p2p::past::testing::PastRegrTest_testCaching_6
...
public: /* protected */
    PastRegrTest_testCaching_6(PastRegrTest *PastRegrTest_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::commonapi::Id* id1, ::rice::p2p::past::PastContent* file1, ::rice::p2p::commonapi::Id* id2, ::rice::p2p::past::PastContent* file2, ::rice::p2p::past::PastContent* file3);
