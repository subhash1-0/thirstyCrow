...
class rice::p2p::past::testing::PastRegrTest_testLookupHandles_5_receive_5_1
...
public: /* protected */
    PastRegrTest_testLookupHandles_5_receive_5_1(PastRegrTest_testLookupHandles_5 *PastRegrTest_testLookupHandles_5_this, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastImpl* local);

public:
    static ::java::lang::Class *class_();
    PastRegrTest_testLookupHandles_5 *PastRegrTest_testLookupHandles_5_this;
