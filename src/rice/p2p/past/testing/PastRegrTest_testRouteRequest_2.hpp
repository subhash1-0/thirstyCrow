...
class rice::p2p::past::testing::PastRegrTest_testRouteRequest_2
...
public: /* protected */
    PastRegrTest_testRouteRequest_2(PastRegrTest *PastRegrTest_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::past::PastContent* file, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastImpl* remote);
