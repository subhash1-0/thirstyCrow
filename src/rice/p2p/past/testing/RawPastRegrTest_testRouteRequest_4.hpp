...
class rice::p2p::past::testing::RawPastRegrTest_testRouteRequest_4
...
public: /* protected */
    RawPastRegrTest_testRouteRequest_4(RawPastRegrTest *RawPastRegrTest_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::past::PastContent* file, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastImpl* remote);
