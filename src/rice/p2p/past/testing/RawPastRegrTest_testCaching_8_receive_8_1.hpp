...
class rice::p2p::past::testing::RawPastRegrTest_testCaching_8_receive_8_1
...
public: /* protected */
    RawPastRegrTest_testCaching_8_receive_8_1(RawPastRegrTest_testCaching_8 *RawPastRegrTest_testCaching_8_this, ::rice::p2p::past::PastContent* file1, ::rice::p2p::commonapi::Id* id2, ::rice::p2p::past::PastImpl* local, ::rice::p2p::past::PastContent* file2, ::rice::p2p::past::PastContent* file3);

public:
    static ::java::lang::Class *class_();
    RawPastRegrTest_testCaching_8 *RawPastRegrTest_testCaching_8_this;
