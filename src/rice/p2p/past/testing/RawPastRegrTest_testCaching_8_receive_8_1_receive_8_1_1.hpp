...
class rice::p2p::past::testing::RawPastRegrTest_testCaching_8_receive_8_1_receive_8_1_1
...
public: /* protected */
    RawPastRegrTest_testCaching_8_receive_8_1_receive_8_1_1(RawPastRegrTest_testCaching_8_receive_8_1 *RawPastRegrTest_testCaching_8_receive_8_1_this, ::rice::p2p::past::messaging::LookupMessage* lmsg, ::rice::p2p::past::PastContent* file3, ::rice::p2p::past::PastImpl* local, ::rice::p2p::commonapi::Id* id2);

public:
    static ::java::lang::Class *class_();
    RawPastRegrTest_testCaching_8_receive_8_1 *RawPastRegrTest_testCaching_8_receive_8_1_this;
    ::rice::p2p::past::messaging::LookupMessage* lmsg;
    ::rice::p2p::past::PastContent* file3;
    ::rice::p2p::past::PastImpl* local;
    ::rice::p2p::commonapi::Id* id2;
