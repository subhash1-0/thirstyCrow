...
class rice::p2p::past::testing::PastRegrTest_testVersionControl_3_receive_3_1_receive_3_1_1
...
public: /* protected */
    PastRegrTest_testVersionControl_3_receive_3_1_receive_3_1_1(PastRegrTest_testVersionControl_3_receive_3_1 *PastRegrTest_testVersionControl_3_receive_3_1_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastContent* newFile, ::rice::p2p::past::PastContent* newNewFile);

public:
    static ::java::lang::Class *class_();
    PastRegrTest_testVersionControl_3_receive_3_1 *PastRegrTest_testVersionControl_3_receive_3_1_this;
