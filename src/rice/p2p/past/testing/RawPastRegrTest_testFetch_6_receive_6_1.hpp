...
class rice::p2p::past::testing::RawPastRegrTest_testFetch_6_receive_6_1
...
public: /* protected */
    RawPastRegrTest_testFetch_6_receive_6_1(RawPastRegrTest_testFetch_6 *RawPastRegrTest_testFetch_6_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::past::PastContentHandle* handle1, ::rice::p2p::past::PastContent* file1, ::rice::p2p::past::PastContent* file2, ::rice::p2p::past::PastContentHandle* handle2, ::rice::p2p::past::PastImpl* remote1, ::rice::p2p::commonapi::Id* id, ::rice::p2p::past::PastImpl* remote2);

public:
    static ::java::lang::Class *class_();
    RawPastRegrTest_testFetch_6 *RawPastRegrTest_testFetch_6_this;
    ::rice::p2p::past::PastImpl* local;
    ::rice::p2p::past::PastContentHandle* handle1;
