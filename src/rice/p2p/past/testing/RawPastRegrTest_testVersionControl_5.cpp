...
rice::p2p::past::testing::RawPastRegrTest_testVersionControl_5::RawPastRegrTest_testVersionControl_5(RawPastRegrTest *RawPastRegrTest_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastContent* oldFile, ::rice::p2p::past::PastContent* newFile, ::rice::p2p::past::PastContent* newNewFile)
...
void rice::p2p::past::testing::RawPastRegrTest_testVersionControl_5::receive(::java::lang::Object* result) /* throws(Exception) */
{
    ...
    RawPastRegrTest_this->stepStart(u"Remote File Lookup"_j);
    npc(local)->lookup(remoteId, static_cast< ::rice::Continuation* >(new RawPastRegrTest_testVersionControl_5_receive_5_1(this, oldFile, local, newFile, remoteId, newNewFile)));
    RawPastRegrTest_this->simulate();
}

extern java::lang::Class *class_(const char16_t *c, int n);

java::lang::Class* rice::p2p::past::testing::RawPastRegrTest_testVersionControl_5::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* rice::p2p::past::testing::RawPastRegrTest_testVersionControl_5::getClass0()
{
    return class_();
}
