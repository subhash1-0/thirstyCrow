...
class rice::p2p::past::testing::PastRegrTest_NonMutableTestPastContent
...
public:
    ...
    // Generated
    PastRegrTest_NonMutableTestPastContent(::rice::p2p::commonapi::Id* id);
protected:
    PastRegrTest_NonMutableTestPastContent(const ::default_init_tag&);
