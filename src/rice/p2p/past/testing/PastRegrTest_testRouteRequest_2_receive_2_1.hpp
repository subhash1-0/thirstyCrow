...
class rice::p2p::past::testing::PastRegrTest_testRouteRequest_2_receive_2_1
...
public: /* protected */
    PastRegrTest_testRouteRequest_2_receive_2_1(PastRegrTest_testRouteRequest_2 *PastRegrTest_testRouteRequest_2_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastContent* file, ::rice::p2p::past::PastImpl* remote);

public:
    static ::java::lang::Class *class_();
    PastRegrTest_testRouteRequest_2 *PastRegrTest_testRouteRequest_2_this;
