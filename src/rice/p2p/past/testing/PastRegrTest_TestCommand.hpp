...
class rice::p2p::past::testing::PastRegrTest_TestCommand
...
public:
    ...
    // Generated
    PastRegrTest_TestCommand(PastRegrTest *PastRegrTest_this);
protected:
    PastRegrTest_TestCommand(PastRegrTest *PastRegrTest_this, const ::default_init_tag&);
