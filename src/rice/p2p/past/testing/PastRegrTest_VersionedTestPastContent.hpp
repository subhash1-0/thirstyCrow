...
class rice::p2p::past::testing::PastRegrTest_VersionedTestPastContent
    : public PastRegrTest_TestPastContent
{

public:
    typedef PastRegrTest_TestPastContent super;
...
public:
    ...
    // Generated
    PastRegrTest_VersionedTestPastContent(::rice::p2p::commonapi::Id* id, int32_t version);
protected:
    PastRegrTest_VersionedTestPastContent(const ::default_init_tag&);
