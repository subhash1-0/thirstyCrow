...
class rice::p2p::past::testing::RawPastRegrTest_testVersionControl_5
...
public: /* protected */
    RawPastRegrTest_testVersionControl_5(RawPastRegrTest *RawPastRegrTest_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastContent* oldFile, ::rice::p2p::past::PastContent* newFile, ::rice::p2p::past::PastContent* newNewFile);
