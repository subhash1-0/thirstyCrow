...
class rice::p2p::past::testing::RawPastRegrTest_testLookupHandles_7
...
public: /* protected */
    RawPastRegrTest_testLookupHandles_7(RawPastRegrTest *RawPastRegrTest_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::commonapi::Id* remoteId);
