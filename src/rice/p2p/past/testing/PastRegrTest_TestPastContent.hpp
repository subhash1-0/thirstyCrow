...
class rice::p2p::past::testing::PastRegrTest_TestPastContent
...
public:
    ...
    // Generated
    PastRegrTest_TestPastContent(::rice::p2p::commonapi::Id* id);
protected:
    PastRegrTest_TestPastContent(const ::default_init_tag&);
