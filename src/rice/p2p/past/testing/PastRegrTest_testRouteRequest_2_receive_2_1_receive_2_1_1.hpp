...
class rice::p2p::past::testing::PastRegrTest_testRouteRequest_2_receive_2_1_receive_2_1_1
...
public: /* protected */
    PastRegrTest_testRouteRequest_2_receive_2_1_receive_2_1_1(PastRegrTest_testRouteRequest_2_receive_2_1 *PastRegrTest_testRouteRequest_2_receive_2_1_this, ::rice::p2p::past::PastContent* file, ::rice::p2p::past::PastImpl* remote, ::rice::p2p::commonapi::Id* remoteId);

public:
    static ::java::lang::Class *class_();
    PastRegrTest_testRouteRequest_2_receive_2_1 *PastRegrTest_testRouteRequest_2_receive_2_1_this;
    ::rice::p2p::past::PastContent* file;
    ::rice::p2p::past::PastImpl* remote;
