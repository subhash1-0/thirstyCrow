...
class rice::p2p::past::testing::RawPastRegrTest_testRouteRequest_4_receive_4_1
...
public: /* protected */
    RawPastRegrTest_testRouteRequest_4_receive_4_1(RawPastRegrTest_testRouteRequest_4 *RawPastRegrTest_testRouteRequest_4_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::commonapi::Id* remoteId, ::rice::p2p::past::PastContent* file, ::rice::p2p::past::PastImpl* remote);

public:
    static ::java::lang::Class *class_();
    RawPastRegrTest_testRouteRequest_4 *RawPastRegrTest_testRouteRequest_4_this;
