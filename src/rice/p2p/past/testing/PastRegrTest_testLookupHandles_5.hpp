...
class rice::p2p::past::testing::PastRegrTest_testLookupHandles_5
...
public: /* protected */
    PastRegrTest_testLookupHandles_5(PastRegrTest *PastRegrTest_this, ::rice::p2p::past::PastImpl* local, ::rice::p2p::commonapi::Id* remoteId);
