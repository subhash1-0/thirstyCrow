...
class rice::p2p::past::testing::RawPastRegrTest_TestCommand
...
public:
    ...
    // Generated
    RawPastRegrTest_TestCommand(RawPastRegrTest *RawPastRegrTest_this);
protected:
    RawPastRegrTest_TestCommand(RawPastRegrTest *RawPastRegrTest_this, const ::default_init_tag&);
