...
class rice::p2p::past::PastImpl_deliver_12
...
public:
    ...
    // Generated
    PastImpl_deliver_12(PastImpl *PastImpl_this, ::rice::p2p::past::messaging::LookupMessage* lmsg, ::rice::Continuation* continuation);
