...
class rice::p2p::past::PastImpl_remove_15_receiveResult_15_1
...
public:
    ...
    // Generated
    PastImpl_remove_15_receiveResult_15_1(PastImpl_remove_15 *PastImpl_remove_15_this, ::rice::p2p::commonapi::Id* id, ::rice::Continuation* continuation);
    static ::java::lang::Class *class_();
    PastImpl_remove_15 *PastImpl_remove_15_this;
