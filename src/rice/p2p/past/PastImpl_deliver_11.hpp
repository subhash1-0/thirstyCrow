...
class rice::p2p::past::PastImpl_deliver_11
...
public:
    ...
    // Generated
    PastImpl_deliver_11(PastImpl *PastImpl_this, ::rice::p2p::commonapi::Id* msgid, ::rice::p2p::past::messaging::InsertMessage* imsg, ::rice::p2p::past::messaging::PastMessage* msg, ::rice::Continuation* continuation);
