...
class rice::p2p::past::PastImpl_deliver_11_receiveResult_11_1_receiveResult_11_1_1
...
public:
    ...
    // Generated
    PastImpl_deliver_11_receiveResult_11_1_receiveResult_11_1_1(PastImpl_deliver_11_receiveResult_11_1 *PastImpl_deliver_11_receiveResult_11_1_this, ::rice::p2p::past::messaging::PastMessage* msg, ::rice::p2p::commonapi::Id* msgid, ::rice::Continuation* continuation);
    static ::java::lang::Class *class_();
    PastImpl_deliver_11_receiveResult_11_1 *PastImpl_deliver_11_receiveResult_11_1_this;
    ::rice::p2p::past::messaging::PastMessage* msg;
    ::rice::p2p::commonapi::Id* msgid;
