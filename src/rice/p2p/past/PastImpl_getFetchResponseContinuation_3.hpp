...
class rice::p2p::past::PastImpl_getFetchResponseContinuation_3
...
public:
    ...
    // Generated
    PastImpl_getFetchResponseContinuation_3(PastImpl *PastImpl_this, ::rice::p2p::past::messaging::ContinuationMessage* cmsg, ::rice::p2p::past::messaging::PastMessage* msg);
    static ::java::lang::Class *class_();
    PastImpl *PastImpl_this;
    ::rice::p2p::past::messaging::ContinuationMessage* cmsg;
