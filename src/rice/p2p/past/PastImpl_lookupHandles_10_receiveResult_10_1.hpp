...
class rice::p2p::past::PastImpl_lookupHandles_10_receiveResult_10_1
...
public:
    ...
    // Generated
    PastImpl_lookupHandles_10_receiveResult_10_1(PastImpl_lookupHandles_10 *PastImpl_lookupHandles_10_this, ::rice::Continuation* parent, int32_t num);
    static ::java::lang::Class *class_();
    PastImpl_lookupHandles_10 *PastImpl_lookupHandles_10_this;
