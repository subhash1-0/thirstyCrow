...
class rice::p2p::past::PastImpl_insert_8
    : public ::rice::Continuation_StandardContinuation
{

public:
    typedef ::rice::Continuation_StandardContinuation super;
    void receiveResult(::java::lang::Object* array) override;

    // Generated
    PastImpl_insert_8(PastImpl *PastImpl_this, PastContent* obj, ::rice::Continuation* continuation);
