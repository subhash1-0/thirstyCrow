...
class rice::p2p::past::PastImpl_reInsert_17_receiveResult_17_1
...
public:
    ...
    // Generated
    PastImpl_reInsert_17_receiveResult_17_1(PastImpl_reInsert_17 *PastImpl_reInsert_17_this, ::rice::Continuation* continuation);
    static ::java::lang::Class *class_();
    PastImpl_reInsert_17 *PastImpl_reInsert_17_this;
