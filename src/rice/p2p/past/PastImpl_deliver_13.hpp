...
class rice::p2p::past::PastImpl_deliver_13
...
public:
    ...
    // Generated
    PastImpl_deliver_13(PastImpl *PastImpl_this, ::rice::p2p::past::messaging::FetchHandleMessage* fmsg, ::rice::Continuation* continuation);
