...
rice::p2p::past::gc::GCPastImpl_reInsert_11_receiveResult_11_1::GCPastImpl_reInsert_11_receiveResult_11_1(GCPastImpl_reInsert_11 *GCPastImpl_reInsert_11_this, ::rice::Continuation* continuation)
    : super(*static_cast< ::default_init_tag* >(0))
    , GCPastImpl_reInsert_11_this(GCPastImpl_reInsert_11_this)
{
    clinit();
    ctor(continuation);
}

void rice::p2p::past::gc::GCPastImpl_reInsert_11_receiveResult_11_1::receiveResult(::java::lang::Object* result)
{
...
java::lang::Class* rice::p2p::past::gc::GCPastImpl_reInsert_11_receiveResult_11_1::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* rice::p2p::past::gc::GCPastImpl_reInsert_11_receiveResult_11_1::getClass0()
{
    return class_();
}
