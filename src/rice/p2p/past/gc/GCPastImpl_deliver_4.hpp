...
class rice::p2p::past::gc::GCPastImpl_deliver_4
...
public:
    ...
    // Generated
    GCPastImpl_deliver_4(GCPastImpl *GCPastImpl_this, ::rice::p2p::past::gc::messaging::GCInsertMessage* imsg, ::rice::Continuation* continuation);
    static ::java::lang::Class *class_();
    GCPastImpl *GCPastImpl_this;
    ::rice::p2p::past::gc::messaging::GCInsertMessage* imsg;
