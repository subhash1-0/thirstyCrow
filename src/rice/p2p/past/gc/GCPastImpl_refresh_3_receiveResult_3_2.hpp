...
class rice::p2p::past::gc::GCPastImpl_refresh_3_receiveResult_3_2
...
public:
    ...
    // Generated
    GCPastImpl_refresh_3_receiveResult_3_2(GCPastImpl_refresh_3 *GCPastImpl_refresh_3_this, ::rice::environment::logging::Logger* logger, GCPastImpl_ReplicaMap* map, GCIdSet* ids, ::rice::Continuation* continuation);
