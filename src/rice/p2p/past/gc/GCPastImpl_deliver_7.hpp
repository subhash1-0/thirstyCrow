...
class rice::p2p::past::gc::GCPastImpl_deliver_7
...
public:
    ...
    // Generated
    GCPastImpl_deliver_7(GCPastImpl *GCPastImpl_this, ::rice::p2p::past::messaging::FetchHandleMessage* fmsg, ::rice::Continuation* continuation);
    static ::java::lang::Class *class_();
    GCPastImpl *GCPastImpl_this;
    ::rice::p2p::past::messaging::FetchHandleMessage* fmsg;
