...
class rice::p2p::past::gc::GCPastImpl_fetch_10
...
public:
    ...
    // Generated
    GCPastImpl_fetch_10(GCPastImpl *GCPastImpl_this, ::rice::p2p::commonapi::Id* id, GCId* gcid, ::rice::Continuation* continuation);
