...
class rice::p2p::past::gc::GCPastImpl_refresh_2
...
public:
    ...
    // Generated
    GCPastImpl_refresh_2(GCPastImpl *GCPastImpl_this, ::rice::p2p::commonapi::IdArray* array, ::rice::Continuation* continuation);
