...
class rice::p2p::past::gc::GCPastImpl_deliver_5_receiveResult_5_2
...
public:
    ...
    // Generated
    GCPastImpl_deliver_5_receiveResult_5_2(GCPastImpl_deliver_5 *GCPastImpl_deliver_5_this, GCId* id, ::rice::Continuation* continuation);
