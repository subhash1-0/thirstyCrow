...
class rice::p2p::past::gc::GCPastImpl_reInsert_11
...
public:
    ...
    // Generated
    GCPastImpl_reInsert_11(GCPastImpl *GCPastImpl_this, ::rice::p2p::commonapi::Id* id, ::rice::Continuation* continuation);
