...
class rice::p2p::past::gc::GCPastImpl_collect_8_receiveResult_8_1_receiveResult_8_1_1
...
public:
    ...
    // Generated
    GCPastImpl_collect_8_receiveResult_8_1_receiveResult_8_1_1(GCPastImpl_collect_8_receiveResult_8_1 *GCPastImpl_collect_8_receiveResult_8_1_this, ::rice::p2p::commonapi::Id* gid, ::rice::Continuation* continuation);
    static ::java::lang::Class *class_();
    GCPastImpl_collect_8_receiveResult_8_1 *GCPastImpl_collect_8_receiveResult_8_1_this;
    ::rice::p2p::commonapi::Id* gid;
