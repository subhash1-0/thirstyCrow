...
class rice::p2p::past::gc::GCPastImpl_reInsert_11_receiveResult_11_1
...
public:
    ...
    // Generated
    GCPastImpl_reInsert_11_receiveResult_11_1(GCPastImpl_reInsert_11 *GCPastImpl_reInsert_11_this, ::rice::Continuation* continuation);
    static ::java::lang::Class *class_();
    GCPastImpl_reInsert_11 *GCPastImpl_reInsert_11_this;
