...
class rice::p2p::past::gc::GCPastImpl_deliver_5
...
public:
    ...
    // Generated
    GCPastImpl_deliver_5(GCPastImpl *GCPastImpl_this, ::java::util::Vector* result, ::java::util::Iterator* i, ::rice::Continuation* continuation);
