...
class rice::p2p::past::PastImpl_lookup_9
...
public:
    ...
    // Generated
    PastImpl_lookup_9(PastImpl *PastImpl_this, ::rice::Continuation* command, ::rice::p2p::commonapi::Id* id, bool cache, ::rice::Continuation* continuation);
