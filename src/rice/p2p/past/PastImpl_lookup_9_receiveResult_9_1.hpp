...
class rice::p2p::past::PastImpl_lookup_9_receiveResult_9_1
...
public:
    ...
    // Generated
    PastImpl_lookup_9_receiveResult_9_1(PastImpl_lookup_9 *PastImpl_lookup_9_this, bool cache, ::rice::Continuation* command_, ::rice::p2p::commonapi::Id* id, ::java::lang::String* name, ::rice::Continuation* command);
    static ::java::lang::Class *class_();
    PastImpl_lookup_9 *PastImpl_lookup_9_this;
    bool cache;
