...
class rice::p2p::past::PastImpl_deliver_11_receiveResult_11_1
...
public:
    ...
    // Generated
    PastImpl_deliver_11_receiveResult_11_1(PastImpl_deliver_11 *PastImpl_deliver_11_this, ::rice::p2p::past::messaging::InsertMessage* imsg, ::rice::p2p::commonapi::Id* msgid, ::rice::p2p::past::messaging::PastMessage* msg, ::rice::Continuation* continuation);
    static ::java::lang::Class *class_();
    PastImpl_deliver_11 *PastImpl_deliver_11_this;
    ::rice::p2p::past::messaging::InsertMessage* imsg;
