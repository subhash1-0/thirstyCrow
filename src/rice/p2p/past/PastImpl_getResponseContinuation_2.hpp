...
class rice::p2p::past::PastImpl_getResponseContinuation_2
...
public:
    ...
    // Generated
    PastImpl_getResponseContinuation_2(PastImpl *PastImpl_this, ::rice::p2p::past::messaging::ContinuationMessage* cmsg, ::rice::p2p::past::messaging::PastMessage* msg);
