...
class rice::p2p::replication::manager::ReplicationManagerImpl_ReplicationManagerDeleter_go_1
...
public:
    ...
    // Generated
    ReplicationManagerImpl_ReplicationManagerDeleter_go_1(ReplicationManagerImpl_ReplicationManagerDeleter *ReplicationManagerImpl_ReplicationManagerDeleter_this, ::rice::Continuation* continuation);
    static ::java::lang::Class *class_();
    ReplicationManagerImpl_ReplicationManagerDeleter *ReplicationManagerImpl_ReplicationManagerDeleter_this;
