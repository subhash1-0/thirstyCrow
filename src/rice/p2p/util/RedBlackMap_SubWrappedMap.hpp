...
class rice::p2p::util::RedBlackMap_SubWrappedMap
...
public: /* package */
    RedBlackMap_SubWrappedMap(RedBlackMap *RedBlackMap_this, ::java::lang::Object* fromKey, ::java::lang::Object* toKey);
protected:
    RedBlackMap_SubWrappedMap(RedBlackMap *RedBlackMap_this, const ::default_init_tag&);
