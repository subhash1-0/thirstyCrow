...
class rice::p2p::util::RedBlackMap_SubWrappedMap_EntrySetView
...
public:
    ...
    // Generated
    RedBlackMap_SubWrappedMap_EntrySetView(RedBlackMap_SubWrappedMap *RedBlackMap_SubWrappedMap_this);
protected:
    void ctor();
    RedBlackMap_SubWrappedMap_EntrySetView(RedBlackMap_SubWrappedMap *RedBlackMap_SubWrappedMap_this, const ::default_init_tag&);
...
private:
    void init();
    RedBlackMap_SubWrappedMap *RedBlackMap_SubWrappedMap_this;
