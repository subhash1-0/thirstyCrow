...
class rice::p2p::util::RedBlackMap_ValueIterator
...
public:
    ...
    // Generated
    RedBlackMap_ValueIterator(RedBlackMap *RedBlackMap_this);
protected:
    RedBlackMap_ValueIterator(RedBlackMap *RedBlackMap_this, const ::default_init_tag&);
