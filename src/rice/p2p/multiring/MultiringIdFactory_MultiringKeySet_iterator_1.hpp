...
class rice::p2p::multiring::MultiringIdFactory_MultiringKeySet_iterator_1
...
public:
    ...
    // Generated
    MultiringIdFactory_MultiringKeySet_iterator_1(MultiringIdFactory_MultiringKeySet *MultiringIdFactory_MultiringKeySet_this);
    static ::java::lang::Class *class_();

private:
    void init();
    MultiringIdFactory_MultiringKeySet *MultiringIdFactory_MultiringKeySet_this;
