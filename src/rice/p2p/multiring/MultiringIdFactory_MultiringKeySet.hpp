...
class rice::p2p::multiring::MultiringIdFactory_MultiringKeySet
...
public:
    ...
    // Generated
    MultiringIdFactory_MultiringKeySet(MultiringIdFactory *MultiringIdFactory_this, ::java::util::Set* set);
protected:
    MultiringIdFactory_MultiringKeySet(MultiringIdFactory *MultiringIdFactory_this, const ::default_init_tag&);
