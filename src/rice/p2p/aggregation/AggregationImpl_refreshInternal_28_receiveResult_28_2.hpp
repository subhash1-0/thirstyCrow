...
class rice::p2p::aggregation::AggregationImpl_refreshInternal_28_receiveResult_28_2
...
public:
    ...
    // Generated
    AggregationImpl_refreshInternal_28_receiveResult_28_2(AggregationImpl_refreshInternal_28 *AggregationImpl_refreshInternal_28_this, ::rice::p2p::glacier::VersionKey* vkey, ::rice::Continuation* myParent);
