...
class rice::p2p::aggregation::Moraine_lookup_5_receiveResult_5_1
...
public:
    ...
    // Generated
    Moraine_lookup_5_receiveResult_5_1(Moraine_lookup_5 *Moraine_lookup_5_this, ::rice::Continuation* command);
    static ::java::lang::Class *class_();
    Moraine_lookup_5 *Moraine_lookup_5_this;
