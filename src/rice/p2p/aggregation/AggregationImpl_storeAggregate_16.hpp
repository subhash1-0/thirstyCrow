...
class rice::p2p::aggregation::AggregationImpl_storeAggregate_16
...
public:
    ...
    // Generated
    AggregationImpl_storeAggregate_16(AggregationImpl *AggregationImpl_this, Aggregate* aggr, int64_t expiration, ObjectDescriptorArray* desc, ::rice::p2p::commonapi::IdArray* pointers, ::rice::Continuation* command);
