...
class rice::p2p::aggregation::AggregationImpl_lookup_35
...
public:
    ...
    // Generated
    AggregationImpl_lookup_35(AggregationImpl *AggregationImpl_this, ::rice::p2p::commonapi::Id* id, int64_t version, ::rice::Continuation* command);
