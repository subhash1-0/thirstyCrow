...
class rice::p2p::aggregation::AggregationImpl_lookup_33
...
public:
    ...
    // Generated
    AggregationImpl_lookup_33(AggregationImpl *AggregationImpl_this, ::rice::p2p::commonapi::Id* id, ::rice::Continuation* command);
