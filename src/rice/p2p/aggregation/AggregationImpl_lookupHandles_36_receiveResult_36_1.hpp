...
class rice::p2p::aggregation::AggregationImpl_lookupHandles_36_receiveResult_36_1
...
public:
    ...
    // Generated
    AggregationImpl_lookupHandles_36_receiveResult_36_1(AggregationImpl_lookupHandles_36 *AggregationImpl_lookupHandles_36_this, ::rice::p2p::commonapi::Id* id, int32_t max, ::rice::Continuation* command);
    static ::java::lang::Class *class_();
    AggregationImpl_lookupHandles_36 *AggregationImpl_lookupHandles_36_this;
