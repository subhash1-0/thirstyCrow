...
class rice::p2p::aggregation::AggregationImpl_formAggregates_17
...
public:
    ...
    // Generated
    AggregationImpl_formAggregates_17(AggregationImpl *AggregationImpl_this, ::rice::Continuation* command, ::rice::Continuation* parent);
    static ::java::lang::Class *class_();
    AggregationImpl *AggregationImpl_this;
    ::rice::Continuation* command;
    ::rice::Continuation* parent;
