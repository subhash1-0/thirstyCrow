...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_9
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_9(AggregationImpl *AggregationImpl_this, ::java::lang::StringArray* ret);
