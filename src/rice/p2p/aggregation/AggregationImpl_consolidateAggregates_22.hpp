...
class rice::p2p::aggregation::AggregationImpl_consolidateAggregates_22
...
public:
    ...
    // Generated
    AggregationImpl_consolidateAggregates_22(AggregationImpl *AggregationImpl_this, AggregateArray* aggr, ::java::util::Vector* componentList, int32_t objectsTotal, AggregateDescriptorArray* adc, int64_t now);
