...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_6
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_6(AggregationImpl *AggregationImpl_this, ::java::lang::StringArray* ret);
