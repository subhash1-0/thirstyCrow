...
class rice::p2p::aggregation::AggregationImpl_lookupHandles_36
...
public:
    ...
    // Generated
    AggregationImpl_lookupHandles_36(AggregationImpl *AggregationImpl_this, ::rice::p2p::commonapi::Id* id, int32_t max, ::rice::Continuation* command);
