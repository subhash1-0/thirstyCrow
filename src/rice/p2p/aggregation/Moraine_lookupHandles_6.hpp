...
class rice::p2p::aggregation::Moraine_lookupHandles_6
...
public:
    ...
    // Generated
    Moraine_lookupHandles_6(Moraine *Moraine_this, ::rice::p2p::commonapi::Id* id, int64_t version, int32_t num, ::rice::Continuation* command);
