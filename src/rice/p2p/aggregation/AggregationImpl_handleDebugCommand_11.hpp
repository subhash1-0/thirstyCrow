...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_11
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_11(AggregationImpl *AggregationImpl_this, ::java::lang::StringArray* ret);
