...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_13
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_13(AggregationImpl *AggregationImpl_this, int32_t numFiles, int32_t avgBurstSize, double sizeSkew, int32_t smallSize, int32_t largeSize, int64_t expiration);
