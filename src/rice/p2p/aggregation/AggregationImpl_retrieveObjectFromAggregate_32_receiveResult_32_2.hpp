...
class rice::p2p::aggregation::AggregationImpl_retrieveObjectFromAggregate_32_receiveResult_32_2
...
public:
    ...
    // Generated
    AggregationImpl_retrieveObjectFromAggregate_32_receiveResult_32_2(AggregationImpl_retrieveObjectFromAggregate_32 *AggregationImpl_retrieveObjectFromAggregate_32_this, AggregateDescriptor* adc, ::rice::Continuation* command, int32_t objDescIndex, Aggregate* aggr);
    static ::java::lang::Class *class_();
    AggregationImpl_retrieveObjectFromAggregate_32 *AggregationImpl_retrieveObjectFromAggregate_32_this;
    AggregateDescriptor* adc;
    ::rice::Continuation* command;
    int32_t objDescIndex;
    Aggregate* aggr;
