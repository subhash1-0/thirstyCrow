...
class rice::p2p::aggregation::JavaSerializedAggregateFactory
    : public virtual ::java::lang::Object
    , public virtual AggregateFactory
{

public:
    typedef ::java::lang::Object super;
    Aggregate* buildAggregate(::rice::p2p::past::gc::GCPastContentArray* components, ::rice::p2p::commonapi::IdArray* pointers) override;
    Aggregate* buildAggregate(::rice::p2p::past::gc::rawserialization::RawGCPastContentArray* components, ::rice::p2p::commonapi::IdArray* pointers) override;

    // Generated
    JavaSerializedAggregateFactory();
protected:
    JavaSerializedAggregateFactory(const ::default_init_tag&);
