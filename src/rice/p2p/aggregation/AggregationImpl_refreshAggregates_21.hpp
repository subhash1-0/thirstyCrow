...
class rice::p2p::aggregation::AggregationImpl_refreshAggregates_21
...
public:
    ...
    // Generated
    AggregationImpl_refreshAggregates_21(AggregationImpl *AggregationImpl_this, ::java::util::Vector* refreshAggregateList, ::java::util::Vector* refreshLifetimeList);
    static ::java::lang::Class *class_();
    AggregationImpl *AggregationImpl_this;
    ::java::util::Vector* refreshAggregateList;
    ::java::util::Vector* refreshLifetimeList;
