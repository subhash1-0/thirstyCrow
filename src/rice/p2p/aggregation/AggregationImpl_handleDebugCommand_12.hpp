...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_12
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_12(AggregationImpl *AggregationImpl_this, ::java::lang::StringBuffer* result, int64_t now, ::java::lang::StringArray* ret);
