...
class rice::p2p::aggregation::AggregationImpl_rebuildRecursive_29_receiveResult_29_1
...
public:
    ...
    // Generated
    AggregationImpl_rebuildRecursive_29_receiveResult_29_1(AggregationImpl_rebuildRecursive_29 *AggregationImpl_rebuildRecursive_29_this, ::java::util::Vector* keysInProgress, ::rice::p2p::commonapi::Id* fromKey, ::java::util::Vector* keysDone, ::rice::p2p::past::PastContentHandle* thisHandle, ::java::util::Vector* keysPostponed, ::rice::Continuation* command, ::rice::Continuation* outerContinuation);
    static ::java::lang::Class *class_();
    AggregationImpl_rebuildRecursive_29 *AggregationImpl_rebuildRecursive_29_this;
    ::java::util::Vector* keysInProgress;
    ::rice::p2p::commonapi::Id* fromKey;
    ::java::util::Vector* keysDone;
    ::rice::p2p::past::PastContentHandle* thisHandle;
    ::java::util::Vector* keysPostponed;
