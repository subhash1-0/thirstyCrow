...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_14
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_14(AggregationImpl *AggregationImpl_this, ::java::lang::StringArray* ret);
