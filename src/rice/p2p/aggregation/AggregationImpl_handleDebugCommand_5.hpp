...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_5
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_5(AggregationImpl *AggregationImpl_this, ::java::lang::StringArray* ret);
