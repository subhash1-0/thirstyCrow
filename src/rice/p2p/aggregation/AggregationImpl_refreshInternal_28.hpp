...
class rice::p2p::aggregation::AggregationImpl_refreshInternal_28
...
public: /* package */
    int32_t objectsMissing {  };
    int32_t objectsFetched {  };
...
public:
    ...
    // Generated
    AggregationImpl_refreshInternal_28(AggregationImpl *AggregationImpl_this, ::rice::p2p::commonapi::IdArray* ids, ::java::lang::ObjectArray* result, ::rice::Continuation* command, ::int64_tArray* expirations);
