...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_8
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_8(AggregationImpl *AggregationImpl_this, ::java::lang::StringArray* ret);
