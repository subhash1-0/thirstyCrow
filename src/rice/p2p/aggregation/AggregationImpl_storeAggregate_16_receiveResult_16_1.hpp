...
class rice::p2p::aggregation::AggregationImpl_storeAggregate_16_receiveResult_16_1
...
public:
    ...
    // Generated
    AggregationImpl_storeAggregate_16_receiveResult_16_1(AggregationImpl_storeAggregate_16 *AggregationImpl_storeAggregate_16_this, Aggregate* aggr, int64_t expiration, ObjectDescriptorArray* desc, ::rice::p2p::commonapi::IdArray* pointers, ::rice::Continuation* command);
    static ::java::lang::Class *class_();
    AggregationImpl_storeAggregate_16 *AggregationImpl_storeAggregate_16_this;
    Aggregate* aggr;
    int64_t expiration;
