...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_7
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_7(AggregationImpl *AggregationImpl_this, ::java::lang::StringArray* ret);
