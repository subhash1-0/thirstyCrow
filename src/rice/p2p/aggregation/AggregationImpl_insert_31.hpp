...
class rice::p2p::aggregation::AggregationImpl_insert_31
...
public:
    ...
    // Generated
    AggregationImpl_insert_31(AggregationImpl *AggregationImpl_this, ::rice::p2p::past::PastContent* obj, ::rice::Continuation* command);
