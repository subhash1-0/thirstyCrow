...
class rice::p2p::aggregation::AggregationImpl_formAggregates_18
...
public:
    ...
    // Generated
    AggregationImpl_formAggregates_18(AggregationImpl *AggregationImpl_this, ::rice::p2p::commonapi::Id* thisId);
