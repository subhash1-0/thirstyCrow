...
class rice::p2p::aggregation::AggregationImpl_refresh_26
...
private:
    void refreshInAggregates();

    // Generated

public:
    AggregationImpl_refresh_26(AggregationImpl *AggregationImpl_this, ::rice::p2p::commonapi::IdArray* ids, ::rice::Continuation* command, ::int64_tArray* expirations);
