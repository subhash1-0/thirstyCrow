...
class rice::p2p::aggregation::Moraine_lookup_1_receiveResult_1_1
...
public:
    ...
    // Generated
    Moraine_lookup_1_receiveResult_1_1(Moraine_lookup_1 *Moraine_lookup_1_this, ::rice::Continuation* command);
    static ::java::lang::Class *class_();
    Moraine_lookup_1 *Moraine_lookup_1_this;
