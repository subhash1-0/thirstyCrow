...
class rice::p2p::aggregation::AggregationImpl_refresh_27
...
public:
    ...
    // Generated
    AggregationImpl_refresh_27(AggregationImpl *AggregationImpl_this, ::java::lang::ObjectArray* result, ::rice::Continuation* command);
