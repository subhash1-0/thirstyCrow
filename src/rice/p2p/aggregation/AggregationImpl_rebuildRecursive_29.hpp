...
class rice::p2p::aggregation::AggregationImpl_rebuildRecursive_29
...
public:
    ...
    // Generated
    AggregationImpl_rebuildRecursive_29(AggregationImpl *AggregationImpl_this, ::rice::p2p::commonapi::Id* fromKey, ::java::util::Vector* keysInProgress, ::java::util::Vector* keysDone, ::java::util::Vector* keysPostponed, ::rice::Continuation* command);
