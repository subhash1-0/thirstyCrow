...
class rice::p2p::aggregation::AggregationImpl_retrieveObjectFromAggregate_32
...
public:
    ...
    // Generated
    AggregationImpl_retrieveObjectFromAggregate_32(AggregationImpl *AggregationImpl_this, AggregateDescriptor* adc, ::rice::Continuation* command, int32_t objDescIndex);
