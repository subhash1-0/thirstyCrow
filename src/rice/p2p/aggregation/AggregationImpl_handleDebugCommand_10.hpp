...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_10
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_10(AggregationImpl *AggregationImpl_this, ::java::lang::StringArray* ret);
