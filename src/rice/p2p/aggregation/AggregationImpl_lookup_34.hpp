...
class rice::p2p::aggregation::AggregationImpl_lookup_34
...
public:
    ...
    // Generated
    AggregationImpl_lookup_34(AggregationImpl *AggregationImpl_this, ::rice::p2p::commonapi::Id* id, int64_t version, ::rice::Continuation* command);
