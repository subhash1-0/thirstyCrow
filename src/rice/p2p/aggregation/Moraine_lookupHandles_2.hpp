...
class rice::p2p::aggregation::Moraine_lookupHandles_2
...
public:
    ...
    // Generated
    Moraine_lookupHandles_2(Moraine *Moraine_this, ::rice::p2p::commonapi::Id* id, int32_t max, ::rice::Continuation* command);
