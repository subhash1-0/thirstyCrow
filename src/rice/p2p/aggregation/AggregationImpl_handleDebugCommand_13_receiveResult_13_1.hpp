...
class rice::p2p::aggregation::AggregationImpl_handleDebugCommand_13_receiveResult_13_1
...
public:
    ...
    // Generated
    AggregationImpl_handleDebugCommand_13_receiveResult_13_1(AggregationImpl_handleDebugCommand_13 *AggregationImpl_handleDebugCommand_13_this, int32_t burstSize, double sizeSkew, int32_t smallSize, int32_t largeSize, int64_t expiration, ::rice::Continuation* outerContinuation);
    static ::java::lang::Class *class_();

private:
    void init();
    AggregationImpl_handleDebugCommand_13 *AggregationImpl_handleDebugCommand_13_this;
    int32_t burstSize;
    double sizeSkew;
    int32_t smallSize;
    int32_t largeSize;
    int64_t expiration;
    ::rice::Continuation* outerContinuation;
