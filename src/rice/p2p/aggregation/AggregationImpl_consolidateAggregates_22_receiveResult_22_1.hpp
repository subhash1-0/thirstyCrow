...
class rice::p2p::aggregation::AggregationImpl_consolidateAggregates_22_receiveResult_22_1
...
public:
    ...
    // Generated
    AggregationImpl_consolidateAggregates_22_receiveResult_22_1(AggregationImpl_consolidateAggregates_22 *AggregationImpl_consolidateAggregates_22_this, AggregateDescriptorArray* adc, int32_t objectsTotal, AggregateArray* aggr);
    static ::java::lang::Class *class_();
    AggregationImpl_consolidateAggregates_22 *AggregationImpl_consolidateAggregates_22_this;
    AggregateDescriptorArray* adc;
    int32_t objectsTotal;
    AggregateArray* aggr;
