...
class rice::p2p::aggregation::AggregationImpl_lookup_34_receiveResult_34_1
...
public:
    ...
    // Generated
    AggregationImpl_lookup_34_receiveResult_34_1(AggregationImpl_lookup_34 *AggregationImpl_lookup_34_this, ::rice::p2p::commonapi::Id* id, int64_t version, ::rice::Continuation* command);
    static ::java::lang::Class *class_();
    AggregationImpl_lookup_34 *AggregationImpl_lookup_34_this;
