...
class rice::environment::processing::simple::ProcessingRequest_run_1
...
public:
    ...
    // Generated
    ProcessingRequest_run_1(ProcessingRequest *ProcessingRequest_this, ::java::lang::Object* result);
