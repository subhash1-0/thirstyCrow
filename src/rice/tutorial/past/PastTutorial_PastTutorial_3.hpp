...
class rice::tutorial::past::PastTutorial_PastTutorial_3
...
public:
    ...
    // Generated
    PastTutorial_PastTutorial_3(PastTutorial *PastTutorial_this, ::rice::p2p::commonapi::Id* bogusKey, ::rice::environment::Environment* env);
    static ::java::lang::Class *class_();
    virtual void receiveResult(::java::lang::Object* result) override;
    PastTutorial *PastTutorial_this;
    ::rice::p2p::commonapi::Id* bogusKey;
