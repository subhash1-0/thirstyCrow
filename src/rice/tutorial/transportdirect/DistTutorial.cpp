...
rice::tutorial::transportdirect::DistTutorial::DistTutorial(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::transportdirect::DistTutorial::DistTutorial(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env)  /* throws(Exception) */
    : DistTutorial(*static_cast< ::default_init_tag* >(0))
{
    ctor(bindport,bootaddress,numNodes,env);
}

void rice::tutorial::transportdirect::DistTutorial::init()
{
    apps = new ::java::util::Vector();
}

void rice::tutorial::transportdirect::DistTutorial::ctor(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env) /* throws(Exception) */
{
    super::ctor();
    init();
    ::rice::pastry::direct::NetworkSimulator* const simulator = new ::rice::pastry::direct::EuclideanNetwork(env);
    npc(simulator)->setMaxSpeed(10.0f);
    ::rice::pastry::NodeIdFactory* nidFactory = new ::rice::pastry::standard::RandomNodeIdFactory(env);
    ::rice::pastry::PastryNodeFactory* factory = new DistTutorial_DistTutorial_1(this, simulator, nidFactory, bindport, env);
    npc(simulator)->start();
...
void rice::tutorial::transportdirect::DistTutorial::main(::java::lang::StringArray* args) /* throws(Exception) */
{
    clinit();
...
java::lang::Class* rice::tutorial::transportdirect::DistTutorial::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.transportdirect.DistTutorial", 42);
    return c;
}

java::lang::Class* rice::tutorial::transportdirect::DistTutorial::getClass0()
{
    return class_();
}
