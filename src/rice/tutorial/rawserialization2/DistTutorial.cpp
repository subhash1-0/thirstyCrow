// Generated from /pastry-2.1/src/rice/tutorial/rawserialization2/DistTutorial.java
#include <rice/tutorial/rawserialization2/DistTutorial.hpp>
...
rice::tutorial::rawserialization2::DistTutorial::DistTutorial(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::rawserialization2::DistTutorial::DistTutorial(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env)  /* throws(Exception) */
    : DistTutorial(*static_cast< ::default_init_tag* >(0))
{
    ctor(bindport,bootaddress,numNodes,env);
}

void rice::tutorial::rawserialization2::DistTutorial::init()
{
    apps = new ::java::util::Vector();
}

void rice::tutorial::rawserialization2::DistTutorial::ctor(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env) /* throws(Exception) */
{
    super::ctor();
    init();
...
void rice::tutorial::rawserialization2::DistTutorial::main(::java::lang::StringArray* args) /* throws(Exception) */
{
    clinit();
...
java::lang::Class* rice::tutorial::rawserialization2::DistTutorial::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.rawserialization2.DistTutorial", 44);
    return c;
}

java::lang::Class* rice::tutorial::rawserialization2::DistTutorial::getClass0()
{
    return class_();
}
