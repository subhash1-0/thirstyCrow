...
rice::tutorial::prioritylistener::DistTutorial::DistTutorial(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::prioritylistener::DistTutorial::DistTutorial(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env)  /* throws(Exception) */
    : DistTutorial(*static_cast< ::default_init_tag* >(0))
{
    ctor(bindport,bootaddress,numNodes,env);
}

void rice::tutorial::prioritylistener::DistTutorial::init()
{
    apps = new ::java::util::Vector();
}

void rice::tutorial::prioritylistener::DistTutorial::ctor(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env) /* throws(Exception) */
{
    super::ctor();
    init();
    ...
    for (auto curNode = int32_t(0); curNode < numNodes; curNode++) {
        ...
        auto ptl = java_cast< ::org::mpisws::p2p::transport::priority::PriorityTransportLayer* >(java_cast< ::java::lang::Object* >(npc(npc(node)->getVars())->get(::rice::pastry::socket::SocketPastryNodeFactory::PRIORITY_TL())));
        npc(ptl)->addPriorityTransportLayerListener(new DistTutorial_DistTutorial_1(this, node));
        {
...
void rice::tutorial::prioritylistener::DistTutorial::main(::java::lang::StringArray* args) /* throws(Exception) */
{
    clinit();
...
java::lang::Class* rice::tutorial::prioritylistener::DistTutorial::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.prioritylistener.DistTutorial", 43);
    return c;
}

java::lang::Class* rice::tutorial::prioritylistener::DistTutorial::getClass0()
{
    return class_();
}
