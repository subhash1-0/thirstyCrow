// Generated from /pastry-2.1/src/rice/tutorial/forwarding/DistTutorial.java
...
#include <rice/tutorial/forwarding/MyApp.hpp>
...
rice::tutorial::forwarding::DistTutorial::DistTutorial(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::forwarding::DistTutorial::DistTutorial(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env)  /* throws(Exception) */
    : DistTutorial(*static_cast< ::default_init_tag* >(0))
{
    ctor(bindport,bootaddress,numNodes,env);
}

void rice::tutorial::forwarding::DistTutorial::init()
{
    apps = new ::java::util::Vector();
}

void rice::tutorial::forwarding::DistTutorial::ctor(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env) /* throws(Exception) */
{
    super::ctor();
    init();
...
void rice::tutorial::forwarding::DistTutorial::main(::java::lang::StringArray* args) /* throws(Exception) */
{
    clinit();
    ...
    try {
        ...
        npc(::java::lang::System::out())->println(u"java [-cp FreePastry-<version>.jar] rice.tutorial.forwarding.DistTutorial localbindport bootIP bootPort numNodes"_j);
...
java::lang::Class* rice::tutorial::forwarding::DistTutorial::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.forwarding.DistTutorial", 37);
    return c;
}

java::lang::Class* rice::tutorial::forwarding::DistTutorial::getClass0()
{
    return class_();
}
