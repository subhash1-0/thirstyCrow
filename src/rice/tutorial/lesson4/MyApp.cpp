// Generated from /pastry-2.1/src/rice/tutorial/lesson4/MyApp.java
...
#include <rice/tutorial/lesson4/MyMsg.hpp>
...
rice::tutorial::lesson4::MyApp::MyApp(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::lesson4::MyApp::MyApp(::rice::p2p::commonapi::Node* node) 
    : MyApp(*static_cast< ::default_init_tag* >(0))
{
    ctor(node);
}

void rice::tutorial::lesson4::MyApp::ctor(::rice::p2p::commonapi::Node* node)
{
    super::ctor();
...
rice::p2p::commonapi::Node* rice::tutorial::lesson4::MyApp::getNode()
{
    return node;
}

void rice::tutorial::lesson4::MyApp::routeMyMsg(::rice::p2p::commonapi::Id* id)
{
...
void rice::tutorial::lesson4::MyApp::routeMyMsgDirect(::rice::p2p::commonapi::NodeHandle* nh)
{
...
void rice::tutorial::lesson4::MyApp::deliver(::rice::p2p::commonapi::Id* id, ::rice::p2p::commonapi::Message* message)
{
...
void rice::tutorial::lesson4::MyApp::update(::rice::p2p::commonapi::NodeHandle* handle, bool joined)
{
}

bool rice::tutorial::lesson4::MyApp::forward(::rice::p2p::commonapi::RouteMessage* message)
{
    return true;
}

java::lang::String* rice::tutorial::lesson4::MyApp::toString()
{
...
java::lang::Class* rice::tutorial::lesson4::MyApp::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.lesson4.MyApp", 27);
    return c;
}

java::lang::Class* rice::tutorial::lesson4::MyApp::getClass0()
{
    return class_();
}
