// Generated from /pastry-2.1/src/rice/tutorial/lesson4/DistTutorial.java
#include <rice/tutorial/lesson4/DistTutorial.hpp>
...
#include <rice/tutorial/lesson4/MyApp.hpp>
...
rice::tutorial::lesson4::DistTutorial::DistTutorial(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::lesson4::DistTutorial::DistTutorial(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env)  /* throws(Exception) */
    : DistTutorial(*static_cast< ::default_init_tag* >(0))
{
    ctor(bindport,bootaddress,numNodes,env);
}

void rice::tutorial::lesson4::DistTutorial::init()
{
    apps = new ::java::util::Vector();
}

void rice::tutorial::lesson4::DistTutorial::ctor(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env) /* throws(Exception) */
{
    super::ctor();
    init();
    ...
    auto foo = java_cast< MyApp* >(java_cast< MyApp* >(npc(apps)->get(int32_t(0))));
    npc(::java::lang::System::out())->println(npc(npc((java_cast< ::rice::pastry::PastryNode* >(npc(foo)->node)))->getRoutingTable())->printSelf());
    ::java::lang::System::exit(0);
    for (auto i = int32_t(0); i < 10; i++) {
        auto appIterator = npc(apps)->iterator();
        while (npc(appIterator)->hasNext()) {
            auto app = java_cast< MyApp* >(npc(appIterator)->next());
...
void rice::tutorial::lesson4::DistTutorial::main(::java::lang::StringArray* args) /* throws(Exception) */
{
    clinit();
...
java::lang::Class* rice::tutorial::lesson4::DistTutorial::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.lesson4.DistTutorial", 34);
    return c;
}

java::lang::Class* rice::tutorial::lesson4::DistTutorial::getClass0()
{
    return class_();
}
