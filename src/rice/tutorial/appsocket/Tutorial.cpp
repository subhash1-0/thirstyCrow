// Generated from /pastry-2.1/src/rice/tutorial/appsocket/Tutorial.java
#include <rice/tutorial/appsocket/Tutorial.hpp>
...
rice::tutorial::appsocket::Tutorial::Tutorial(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::appsocket::Tutorial::Tutorial(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env, bool useDirect)  /* throws(Exception) */
    : Tutorial(*static_cast< ::default_init_tag* >(0))
{
    ctor(bindport,bootaddress,numNodes,env,useDirect);
}

void rice::tutorial::appsocket::Tutorial::init()
{
    apps = new ::java::util::Vector();
}

void rice::tutorial::appsocket::Tutorial::ctor(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env, bool useDirect) /* throws(Exception) */
{
    super::ctor();
    init();
...
void rice::tutorial::appsocket::Tutorial::main(::java::lang::StringArray* args) /* throws(Exception) */
{
    clinit();
    try {
        bool useDirect;
...
java::lang::Class* rice::tutorial::appsocket::Tutorial::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.appsocket.Tutorial", 32);
    return c;
}

java::lang::Class* rice::tutorial::appsocket::Tutorial::getClass0()
{
    return class_();
}
