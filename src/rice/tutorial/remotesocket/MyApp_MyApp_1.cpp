...
rice::tutorial::remotesocket::MyApp_MyApp_1::MyApp_MyApp_1(MyApp *MyApp_this, ::rice::p2p::commonapi::IdFactory* factory)
...
void rice::tutorial::remotesocket::MyApp_MyApp_1::receiveSocket(::rice::p2p::commonapi::appsocket::AppSocket* socket)
{
    npc(socket)->register_(true, false, 30000, this);
    npc(MyApp_this->endpoint)->accept(this);
}

void rice::tutorial::remotesocket::MyApp_MyApp_1::receiveSelectResult(::rice::p2p::commonapi::appsocket::AppSocket* socket, bool canRead, bool canWrite)
{
...
void rice::tutorial::remotesocket::MyApp_MyApp_1::receiveException(::rice::p2p::commonapi::appsocket::AppSocket* socket, ::java::lang::Exception* e)
{
...
java::lang::Class* rice::tutorial::remotesocket::MyApp_MyApp_1::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* rice::tutorial::remotesocket::MyApp_MyApp_1::getClass0()
{
    return class_();
}
