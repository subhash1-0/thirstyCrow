...
rice::tutorial::remotesocket::Tutorial::Tutorial(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::remotesocket::Tutorial::Tutorial(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env, bool useDirect)  /* throws(Exception) */
    : Tutorial(*static_cast< ::default_init_tag* >(0))
{
    ctor(bindport,bootaddress,numNodes,env,useDirect);
}

void rice::tutorial::remotesocket::Tutorial::init()
{
    apps = new ::java::util::Vector();
}

void rice::tutorial::remotesocket::Tutorial::ctor(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, int32_t numNodes, ::rice::environment::Environment* env, bool useDirect) /* throws(Exception) */
{
    super::ctor();
    init();
    ...
    npc(sFactory)->getAppSocket(bootaddress, ::rice::pastry::standard::StandardAddress::getAddress(MyApp::class_(), u"myinstance"_j, env), new Tutorial_Tutorial_1(this), nullptr);
}

void rice::tutorial::remotesocket::Tutorial::main(::java::lang::StringArray* args) /* throws(Exception) */
{
    clinit();
    try {
        bool useDirect;
...
java::lang::Class* rice::tutorial::remotesocket::Tutorial::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.remotesocket.Tutorial", 35);
    return c;
}

java::lang::Class* rice::tutorial::remotesocket::Tutorial::getClass0()
{
    return class_();
}
