// Generated from /pastry-2.1/src/rice/tutorial/timer/DistTutorial.java
#include <rice/tutorial/timer/DistTutorial.hpp>
...
rice::tutorial::timer::DistTutorial::DistTutorial(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::timer::DistTutorial::DistTutorial(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, ::rice::environment::Environment* env)  /* throws(Exception) */
    : DistTutorial(*static_cast< ::default_init_tag* >(0))
{
    ctor(bindport,bootaddress,env);
}

void rice::tutorial::timer::DistTutorial::ctor(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, ::rice::environment::Environment* env) /* throws(Exception) */
{
    super::ctor();
...
void rice::tutorial::timer::DistTutorial::main(::java::lang::StringArray* args) /* throws(Exception) */
{
    clinit();
    ...
    try {
        ...
        npc(::java::lang::System::out())->println(u"java [-cp FreePastry-<version>.jar] rice.tutorial.timer.DistTutorial localbindport bootIP bootPort"_j);
        npc(::java::lang::System::out())->println(u"example java rice.tutorial.timer.DistTutorial 9001 pokey.cs.almamater.edu 9001"_j);
        throw e;
    }
}
...
java::lang::Class* rice::tutorial::timer::DistTutorial::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.timer.DistTutorial", 32);
    return c;
}

java::lang::Class* rice::tutorial::timer::DistTutorial::getClass0()
{
    return class_();
}
