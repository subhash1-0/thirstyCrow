...
class rice::tutorial::ssl::DistTutorial
...
protected:
    void ctor(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, ::rice::environment::Environment* env, ::java::io::File* keyStoreFile) /* throws(Exception) */;

public:
    static void main(::java::lang::StringArray* args) /* throws(Exception) */;

    // Generated
    DistTutorial(int32_t bindport, ::java::net::InetSocketAddress* bootaddress, ::rice::environment::Environment* env, ::java::io::File* keyStoreFile);
protected:
