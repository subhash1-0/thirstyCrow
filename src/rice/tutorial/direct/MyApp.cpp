// Generated from /pastry-2.1/src/rice/tutorial/direct/MyApp.java
#include <rice/tutorial/direct/MyApp.hpp>
...
rice::tutorial::direct::MyApp::MyApp(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::direct::MyApp::MyApp(::rice::p2p::commonapi::Node* node) 
    : MyApp(*static_cast< ::default_init_tag* >(0))
{
    ctor(node);
}

void rice::tutorial::direct::MyApp::ctor(::rice::p2p::commonapi::Node* node)
{
    super::ctor();
...
rice::p2p::commonapi::Node* rice::tutorial::direct::MyApp::getNode()
{
    return node;
}

void rice::tutorial::direct::MyApp::routeMyMsg(::rice::p2p::commonapi::Id* id)
{
...
void rice::tutorial::direct::MyApp::routeMyMsgDirect(::rice::p2p::commonapi::NodeHandle* nh)
{
...
void rice::tutorial::direct::MyApp::deliver(::rice::p2p::commonapi::Id* id, ::rice::p2p::commonapi::Message* message)
{
...
void rice::tutorial::direct::MyApp::update(::rice::p2p::commonapi::NodeHandle* handle, bool joined)
{
}

bool rice::tutorial::direct::MyApp::forward(::rice::p2p::commonapi::RouteMessage* message)
{
    return true;
}

java::lang::String* rice::tutorial::direct::MyApp::toString()
{
...
java::lang::Class* rice::tutorial::direct::MyApp::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.direct.MyApp", 26);
    return c;
}

java::lang::Class* rice::tutorial::direct::MyApp::getClass0()
{
    return class_();
}
