...
#include <rice/tutorial/direct/DirectTutorial.hpp>
...
rice::tutorial::direct::DirectTutorial::DirectTutorial(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

rice::tutorial::direct::DirectTutorial::DirectTutorial(int32_t numNodes, ::rice::environment::Environment* env)  /* throws(Exception) */
    : DirectTutorial(*static_cast< ::default_init_tag* >(0))
{
    ctor(numNodes,env);
}

void rice::tutorial::direct::DirectTutorial::init()
{
    apps = new ::java::util::Vector();
}

void rice::tutorial::direct::DirectTutorial::ctor(int32_t numNodes, ::rice::environment::Environment* env) /* throws(Exception) */
{
    super::ctor();
    init();
...
void rice::tutorial::direct::DirectTutorial::main(::java::lang::StringArray* args) /* throws(Exception) */
{
    clinit();
...
java::lang::Class* rice::tutorial::direct::DirectTutorial::class_()
{
    static ::java::lang::Class* c = ::class_(u"rice.tutorial.direct.DirectTutorial", 35);
    return c;
}

java::lang::Class* rice::tutorial::direct::DirectTutorial::getClass0()
{
    return class_();
}
