...
class org::mpisws::p2p::testing::transportlayer::SSLTest_main_2_receiveResult_2_1
...
public:
    ...
    // Generated
    SSLTest_main_2_receiveResult_2_1(SSLTest_main_2 *SSLTest_main_2_this);
    static ::java::lang::Class *class_();

private:
    void init();
    SSLTest_main_2 *SSLTest_main_2_this;
