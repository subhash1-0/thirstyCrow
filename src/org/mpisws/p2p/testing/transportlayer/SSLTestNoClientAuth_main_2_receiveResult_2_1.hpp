...
class org::mpisws::p2p::testing::transportlayer::SSLTestNoClientAuth_main_2_receiveResult_2_1
...
public:
    ...
    // Generated
    SSLTestNoClientAuth_main_2_receiveResult_2_1(SSLTestNoClientAuth_main_2 *SSLTestNoClientAuth_main_2_this);
    static ::java::lang::Class *class_();

private:
    void init();
    SSLTestNoClientAuth_main_2 *SSLTestNoClientAuth_main_2_this;
