...
class org::mpisws::p2p::testing::transportlayer::peerreview::PRRegressionTest_BogusApp_sendMessage_2
...
public:
    ...
    // Generated
    PRRegressionTest_BogusApp_sendMessage_2(PRRegressionTest_BogusApp *PRRegressionTest_BogusApp_this);
