...
class org::mpisws::p2p::testing::transportlayer::peerreview::PRRegressionTest_IdSerializer
...
public:
    ...
    PRRegressionTest_IdImpl* deserialize(::rice::p2p::commonapi::rawserialization::InputBuffer* buf) /* throws(IOException) */ override;
    virtual void serialize(PRRegressionTest_IdImpl* i, ::rice::p2p::commonapi::rawserialization::OutputBuffer* buf) /* throws(IOException) */;

    // Generated
    PRRegressionTest_IdSerializer();
protected:
    PRRegressionTest_IdSerializer(const ::default_init_tag&);
