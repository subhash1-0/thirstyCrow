...
class org::mpisws::p2p::testing::transportlayer::peerreview::PRNonconform2_getBogusApp_1
...
public: /* protected */
    ::int8_tArray* generateMessage() override;

public:
    void notifyStatusChange(PRRegressionTest_IdImpl* id, int32_t newStatus) override;

    // Generated
    PRNonconform2_getBogusApp_1(PRNonconform2 *PRNonconform2_this, PRRegressionTest_Player* player, ::org::mpisws::p2p::transport::TransportLayer* tl, ::rice::environment::Environment* env);
...
private:
    ...
    friend class PRNonconform2_getBogusApp_2;
};
