...
org::mpisws::p2p::testing::transportlayer::peerreview::PRInconsistent1_getBogusApp_2::PRInconsistent1_getBogusApp_2(PRInconsistent1 *PRInconsistent1_this, PRRegressionTest_Player* player, ::org::mpisws::p2p::transport::TransportLayer* tl, ::rice::environment::Environment* env)
    : super(PRInconsistent1_this, *static_cast< ::default_init_tag* >(0))
...
void org::mpisws::p2p::testing::transportlayer::peerreview::PRInconsistent1_getBogusApp_2::notifyStatusChange(PRRegressionTest_IdImpl* id, int32_t newStatus)
{
    ...
    if(newStatus == STATUS_EXPOSED) {
        if(!npc(id)->equals(static_cast< ::java::lang::Object* >(npc(PRInconsistent1_this->bobHandle)->id))) {
            npc(logger)->log(::java::lang::StringBuilder().append(u"Node not trusted: "_j)->append(static_cast< ::java::lang::Object* >(id))->toString());
            ::java::lang::System::exit(1);
        }
    }
    PRInconsistent1_this->addStatusNotification(npc(this->player)->localHandle, id, newStatus);
}

void org::mpisws::p2p::testing::transportlayer::peerreview::PRInconsistent1_getBogusApp_2::notifyStatusChange(::java::lang::Object* id, int32_t newStatus)
{ 
...
java::lang::Class* org::mpisws::p2p::testing::transportlayer::peerreview::PRInconsistent1_getBogusApp_2::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* org::mpisws::p2p::testing::transportlayer::peerreview::PRInconsistent1_getBogusApp_2::getClass0()
{
    return class_();
}
