...
class org::mpisws::p2p::testing::transportlayer::peerreview::PRRegressionTest_IdImpl
...
public:
    ...
    static PRRegressionTest_IdImpl* build(::rice::p2p::commonapi::rawserialization::InputBuffer* buf) /* throws(IOException) */;
    ::java::lang::String* toString() override;
    int32_t hashCode() override;
    bool equals(::java::lang::Object* o) override;

    // Generated
    PRRegressionTest_IdImpl(int32_t id);
protected:
    PRRegressionTest_IdImpl(const ::default_init_tag&);
