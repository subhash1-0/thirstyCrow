...
class org::mpisws::p2p::testing::transportlayer::peerreview::PRRegressionTest_PRRegressionTest_3
...
public:
    ...
    // Generated
    PRRegressionTest_PRRegressionTest_3(PRRegressionTest *PRRegressionTest_this);
