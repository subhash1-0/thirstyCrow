...
class org::mpisws::p2p::testing::transportlayer::WireSRTest_Triplet
...
public:
    WireSRTest_Triplet(::org::mpisws::p2p::transport::sourceroute::SourceRoute* path, ::org::mpisws::p2p::transport::P2PSocket* a, ::org::mpisws::p2p::transport::P2PSocket* b);
protected:
    WireSRTest_Triplet(const ::default_init_tag&);
