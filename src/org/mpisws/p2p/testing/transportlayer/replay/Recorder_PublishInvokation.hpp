...
class org::mpisws::p2p::testing::transportlayer::replay::Recorder_PublishInvokation
...
public:
    ...
    // Generated
    Recorder_PublishInvokation(Recorder *Recorder_this, MyScribeClient* app);
protected:
    Recorder_PublishInvokation(Recorder *Recorder_this, const ::default_init_tag&);
