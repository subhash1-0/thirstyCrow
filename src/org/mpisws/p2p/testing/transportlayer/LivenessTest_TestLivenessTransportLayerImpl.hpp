...
class org::mpisws::p2p::testing::transportlayer::LivenessTest_TestLivenessTransportLayerImpl
...
public:
    ...
    // Generated
    LivenessTest_TestLivenessTransportLayerImpl(::org::mpisws::p2p::transport::TransportLayer* tl, ::rice::environment::Environment* env, ::org::mpisws::p2p::transport::ErrorHandler* errorHandler);
protected:
    LivenessTest_TestLivenessTransportLayerImpl(const ::default_init_tag&);
