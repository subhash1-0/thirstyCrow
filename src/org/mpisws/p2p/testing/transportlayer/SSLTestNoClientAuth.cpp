...
#include <org/mpisws/p2p/testing/transportlayer/SSLTestNoClientAuth_main_1.hpp>
...
org::mpisws::p2p::testing::transportlayer::SSLTestNoClientAuth::SSLTestNoClientAuth(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

org::mpisws::p2p::testing::transportlayer::SSLTestNoClientAuth::SSLTestNoClientAuth()
    : SSLTestNoClientAuth(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

void org::mpisws::p2p::testing::transportlayer::SSLTestNoClientAuth::main(::java::lang::StringArray* args) /* throws(Exception) */
{
    clinit();
    ...
    ::java::security::KeyStore* aliceStore;
    aliceStore = ::java::security::KeyStore::getInstance(u"UBER"_j, u"BC"_j);
    ...
    auto aliceSSL = new ::org::mpisws::p2p::transport::ssl::SSLTransportLayerImpl(aliceWire, aliceStore, nullptr, ::org::mpisws::p2p::transport::ssl::SSLTransportLayer::CLIENT_AUTH_NONE, aliceEnv);
    ...
    ::java::security::KeyStore* bobStore;
    bobStore = ::java::security::KeyStore::getInstance(u"UBER"_j, u"BC"_j);
    ...
    auto bobSSL = new ::org::mpisws::p2p::transport::ssl::SSLTransportLayerImpl(bobWire, nullptr, bobStore, bobEnv);
    npc(aliceSSL)->setCallback(static_cast< ::org::mpisws::p2p::transport::TransportLayerCallback* >(new SSLTestNoClientAuth_main_1()));
    npc(bobSSL)->openSocket(static_cast< ::java::lang::Object* >(aliceAddr), static_cast< ::org::mpisws::p2p::transport::SocketCallback* >(new SSLTestNoClientAuth_main_2()), static_cast< ::java::util::Map* >(nullptr));
}

extern java::lang::Class *class_(const char16_t *c, int n);

java::lang::Class* org::mpisws::p2p::testing::transportlayer::SSLTestNoClientAuth::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.mpisws.p2p.testing.transportlayer.SSLTestNoClientAuth", 57);
    return c;
}

java::lang::Class* org::mpisws::p2p::testing::transportlayer::SSLTestNoClientAuth::getClass0()
{
    return class_();
}
