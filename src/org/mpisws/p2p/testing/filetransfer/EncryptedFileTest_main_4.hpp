...
class org::mpisws::p2p::testing::filetransfer::EncryptedFileTest_main_4
...
public:
    ...
    // Generated
    EncryptedFileTest_main_4(::rice::environment::logging::Logger* logger, ::rice::environment::Environment* env);
