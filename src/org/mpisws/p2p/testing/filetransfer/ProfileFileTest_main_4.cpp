...
org::mpisws::p2p::testing::filetransfer::ProfileFileTest_main_4::ProfileFileTest_main_4(::rice::environment::logging::Logger* logger, ::rice::environment::Environment* env)
...
void org::mpisws::p2p::testing::filetransfer::ProfileFileTest_main_4::receiveResult(::org::mpisws::p2p::transport::SocketRequestHandle* cancellable, ::org::mpisws::p2p::transport::P2PSocket* s)
{
    ...
    ::org::mpisws::p2p::filetransfer::FileTransfer* ft = new ::org::mpisws::p2p::filetransfer::FileTransferImpl(sock, new ProfileFileTest_main_4_receiveResult_4_1(this, logger), env);
    try {
        auto sob = new ::rice::p2p::util::rawserialization::SimpleOutputBuffer();
        npc(sob)->writeUTF(u"foo"_j);
        npc(ft)->sendFile(new ::java::io::File(u"delme.txt"_j), npc(sob)->getByteBuffer(), static_cast< int8_t >(int32_t(0)), new ProfileFileTest_main_4_receiveResult_4_2(this));
    } catch (::java::io::IOException* ioe) {
        npc(logger)->logException(u"Error sending file."_j, ioe);
    }
}

void org::mpisws::p2p::testing::filetransfer::ProfileFileTest_main_4::receiveException(::org::mpisws::p2p::transport::SocketRequestHandle* s, ::java::lang::Exception* ex)
{
...
java::lang::Class* org::mpisws::p2p::testing::filetransfer::ProfileFileTest_main_4::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* org::mpisws::p2p::testing::filetransfer::ProfileFileTest_main_4::getClass0()
{
    return class_();
}
