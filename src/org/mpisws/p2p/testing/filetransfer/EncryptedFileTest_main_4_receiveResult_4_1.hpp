...
class org::mpisws::p2p::testing::filetransfer::EncryptedFileTest_main_4_receiveResult_4_1
...
public:
    ...
    // Generated
    EncryptedFileTest_main_4_receiveResult_4_1(EncryptedFileTest_main_4 *EncryptedFileTest_main_4_this, ::rice::environment::logging::Logger* logger);
