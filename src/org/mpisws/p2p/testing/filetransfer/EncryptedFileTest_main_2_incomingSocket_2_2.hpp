...
class org::mpisws::p2p::testing::filetransfer::EncryptedFileTest_main_2_incomingSocket_2_2
...
public:
    ...
    // Generated
    EncryptedFileTest_main_2_incomingSocket_2_2(EncryptedFileTest_main_2 *EncryptedFileTest_main_2_this, ::java::lang::String* prefix);
