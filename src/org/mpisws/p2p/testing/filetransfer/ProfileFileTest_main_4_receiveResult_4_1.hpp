...
class org::mpisws::p2p::testing::filetransfer::ProfileFileTest_main_4_receiveResult_4_1
...
public:
    ...
    // Generated
    ProfileFileTest_main_4_receiveResult_4_1(ProfileFileTest_main_4 *ProfileFileTest_main_4_this, ::rice::environment::logging::Logger* logger);
