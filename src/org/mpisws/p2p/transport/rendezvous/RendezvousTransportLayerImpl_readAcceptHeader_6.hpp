...
class org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_readAcceptHeader_6
...
public:
    ...
    void receiveSelectResult(::org::mpisws::p2p::transport::P2PSocket* acceptorSocket, bool canRead, bool canWrite) /* throws(IOException) */ override;
    void receiveException(::org::mpisws::p2p::transport::P2PSocket* socket, ::java::lang::Exception* ioe) override;

    // Generated
    RendezvousTransportLayerImpl_readAcceptHeader_6(RendezvousTransportLayerImpl *RendezvousTransportLayerImpl_this, ::org::mpisws::p2p::transport::util::SocketInputBuffer* sib);
