...
void org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_readAcceptHeader_6_receiveSelectResult_6_5::receiveResult(::org::mpisws::p2p::transport::P2PSocket* result)
{
    if(npc(RendezvousTransportLayerImpl_readAcceptHeader_6_this->RendezvousTransportLayerImpl_this->logger)->level <= ::rice::environment::logging::Logger::FINEST)
        npc(RendezvousTransportLayerImpl_readAcceptHeader_6_this->RendezvousTransportLayerImpl_this->logger)->log(::java::lang::StringBuilder().append(u"Acceptor socket complete, setting up forwarding. readAcceptHeader("_j)->append(static_cast< ::java::lang::Object* >(acceptorSocket))
            ->append(u","_j)
    ...
    npc(forwardSockets)->setB(result);
    if(java_cast< ::org::mpisws::p2p::transport::P2PSocket* >(npc(forwardSockets)->a()) != nullptr)
...
void org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_readAcceptHeader_6_receiveSelectResult_6_5::receiveResult(::java::lang::Object* result)
{ 
    receiveResult(dynamic_cast< ::org::mpisws::p2p::transport::P2PSocket* >(result));
}

void org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_readAcceptHeader_6_receiveSelectResult_6_5::receiveException(::java::lang::Exception* exception)
{
    ...
    npc(connectorSocket)->close();
}

extern java::lang::Class *class_(const char16_t *c, int n);

java::lang::Class* org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_readAcceptHeader_6_receiveSelectResult_6_5::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_readAcceptHeader_6_receiveSelectResult_6_5::getClass0()
{
    return class_();
}
