...
class org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_readAcceptHeader_6_receiveSelectResult_6_4
...
public:
    ...
    // Generated
    RendezvousTransportLayerImpl_readAcceptHeader_6_receiveSelectResult_6_4(RendezvousTransportLayerImpl_readAcceptHeader_6 *RendezvousTransportLayerImpl_readAcceptHeader_6_this, ::org::mpisws::p2p::transport::P2PSocket* acceptorSocket, RendezvousContact* target, RendezvousContact* opener, int32_t uid, ::rice::p2p::util::tuples::MutableTuple* forwardSockets);
