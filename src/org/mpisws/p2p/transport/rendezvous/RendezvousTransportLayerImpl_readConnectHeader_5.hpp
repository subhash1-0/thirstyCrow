...
class org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_readConnectHeader_5
...
public:
    ...
    // Generated
    RendezvousTransportLayerImpl_readConnectHeader_5(RendezvousTransportLayerImpl *RendezvousTransportLayerImpl_this, ::org::mpisws::p2p::transport::util::SocketInputBuffer* sib);
