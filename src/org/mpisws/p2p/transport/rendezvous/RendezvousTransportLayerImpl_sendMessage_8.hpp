...
class org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_sendMessage_8
...
public:
    ...
    // Generated
    RendezvousTransportLayerImpl_sendMessage_8(RendezvousTransportLayerImpl *RendezvousTransportLayerImpl_this, ::org::mpisws::p2p::transport::MessageCallback* deliverAckToMe, ::org::mpisws::p2p::transport::util::MessageRequestHandleImpl* ret);
