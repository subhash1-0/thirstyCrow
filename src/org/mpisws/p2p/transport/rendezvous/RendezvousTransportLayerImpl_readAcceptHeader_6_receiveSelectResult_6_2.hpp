...
class org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_readAcceptHeader_6_receiveSelectResult_6_2
...
public:
    ...
    // Generated
    RendezvousTransportLayerImpl_readAcceptHeader_6_receiveSelectResult_6_2(RendezvousTransportLayerImpl_readAcceptHeader_6 *RendezvousTransportLayerImpl_readAcceptHeader_6_this, ::rice::p2p::util::tuples::Tuple* deliverSocketToMe);
