...
class org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_openSocketViaPilot_3_receiveResult_3_1
...
public:
    ...
    RendezvousTransportLayerImpl_openSocketViaPilot_3 *RendezvousTransportLayerImpl_openSocketViaPilot_3_this;
