...
class org::mpisws::p2p::transport::rendezvous::RendezvousTransportLayerImpl_incomingSocket_4
...
public:
    ...
    // Generated
    RendezvousTransportLayerImpl_incomingSocket_4(RendezvousTransportLayerImpl *RendezvousTransportLayerImpl_this);
