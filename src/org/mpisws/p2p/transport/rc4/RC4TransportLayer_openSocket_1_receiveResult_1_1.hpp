...
class org::mpisws::p2p::transport::rc4::RC4TransportLayer_openSocket_1_receiveResult_1_1
...
public:
    ...
    // Generated
    RC4TransportLayer_openSocket_1_receiveResult_1_1(RC4TransportLayer_openSocket_1 *RC4TransportLayer_openSocket_1_this, ::int8_tArray* decryptSeed, ::org::mpisws::p2p::transport::SocketCallback* deliverSocketToMe, ::org::mpisws::p2p::transport::util::SocketRequestHandleImpl* ret, ::java::lang::Object* i, ::java::util::Map* options);
    static ::java::lang::Class *class_();

private:
    void init();
    RC4TransportLayer_openSocket_1 *RC4TransportLayer_openSocket_1_this;
