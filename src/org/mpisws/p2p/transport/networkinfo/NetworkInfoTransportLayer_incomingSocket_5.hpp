...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_incomingSocket_5
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_incomingSocket_5(NetworkInfoTransportLayer *NetworkInfoTransportLayer_this, ::org::mpisws::p2p::transport::P2PSocket* s);
