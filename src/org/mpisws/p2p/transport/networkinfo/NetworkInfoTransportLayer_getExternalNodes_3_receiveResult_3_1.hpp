...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_getExternalNodes_3_receiveResult_3_1
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_getExternalNodes_3_receiveResult_3_1(NetworkInfoTransportLayer_getExternalNodes_3 *NetworkInfoTransportLayer_getExternalNodes_3_this, ::org::mpisws::p2p::transport::util::SocketInputBuffer* sib, ::rice::Continuation* c);
    static ::java::lang::Class *class_();
    NetworkInfoTransportLayer_getExternalNodes_3 *NetworkInfoTransportLayer_getExternalNodes_3_this;
