...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_getId_2_receiveResult_2_1
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_getId_2_receiveResult_2_1(NetworkInfoTransportLayer_getId_2 *NetworkInfoTransportLayer_getId_2_this, ::org::mpisws::p2p::transport::util::SocketInputBuffer* sib, ::rice::Continuation* c);
    static ::java::lang::Class *class_();
    NetworkInfoTransportLayer_getId_2 *NetworkInfoTransportLayer_getId_2_this;
