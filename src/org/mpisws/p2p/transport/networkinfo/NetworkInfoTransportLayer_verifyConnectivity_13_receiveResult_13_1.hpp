...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_verifyConnectivity_13_receiveResult_13_1
...
private:
    void init();
    NetworkInfoTransportLayer_verifyConnectivity_13 *NetworkInfoTransportLayer_verifyConnectivity_13_this;
