...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_getMyInetAddress_1
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_getMyInetAddress_1(NetworkInfoTransportLayer *NetworkInfoTransportLayer_this, ::rice::Continuation* c);
