...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_probe_14
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_probe_14(NetworkInfoTransportLayer *NetworkInfoTransportLayer_this, ::java::net::InetSocketAddress* addr, int64_t uid, ::rice::Continuation* deliverResponseToMe, ::java::util::Map* options, ::boolArray* success, ::rice::p2p::util::AttachableCancellable* ret);
