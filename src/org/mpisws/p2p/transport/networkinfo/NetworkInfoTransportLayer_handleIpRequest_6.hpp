...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_handleIpRequest_6
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_handleIpRequest_6(NetworkInfoTransportLayer *NetworkInfoTransportLayer_this, ::java::nio::ByteBuffer* writeMe);
