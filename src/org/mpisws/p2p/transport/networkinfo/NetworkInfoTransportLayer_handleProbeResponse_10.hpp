...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_handleProbeResponse_10
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_handleProbeResponse_10(NetworkInfoTransportLayer *NetworkInfoTransportLayer_this, ::org::mpisws::p2p::transport::P2PSocket* socket);
