...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_getExternalNodes_3
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_getExternalNodes_3(NetworkInfoTransportLayer *NetworkInfoTransportLayer_this, ::rice::Continuation* c);
