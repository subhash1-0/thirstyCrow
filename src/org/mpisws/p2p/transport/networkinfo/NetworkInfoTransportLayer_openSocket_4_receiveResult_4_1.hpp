...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_openSocket_4_receiveResult_4_1
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_openSocket_4_receiveResult_4_1(NetworkInfoTransportLayer_openSocket_4 *NetworkInfoTransportLayer_openSocket_4_this, ::org::mpisws::p2p::transport::P2PSocket* result);
