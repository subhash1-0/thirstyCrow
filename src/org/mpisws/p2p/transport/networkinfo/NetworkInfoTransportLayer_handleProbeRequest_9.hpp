...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_handleProbeRequest_9
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_handleProbeRequest_9(NetworkInfoTransportLayer *NetworkInfoTransportLayer_this, ::org::mpisws::p2p::transport::P2PSocket* socket);
