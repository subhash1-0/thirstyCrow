...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_probe_15
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_probe_15(NetworkInfoTransportLayer *NetworkInfoTransportLayer_this, ::java::net::InetSocketAddress* addr, int64_t uid, ::rice::Continuation* deliverResponseToMe, ::java::util::Map* options, ::boolArray* success);
    static ::java::lang::Class *class_();
    NetworkInfoTransportLayer *NetworkInfoTransportLayer_this;
    ::java::net::InetSocketAddress* addr;
    int64_t uid;
    ::rice::Continuation* deliverResponseToMe;
