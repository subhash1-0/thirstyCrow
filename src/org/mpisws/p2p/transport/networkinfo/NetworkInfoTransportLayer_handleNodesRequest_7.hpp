...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_handleNodesRequest_7
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_handleNodesRequest_7(NetworkInfoTransportLayer *NetworkInfoTransportLayer_this, ::java::nio::ByteBuffer* writeMe);
