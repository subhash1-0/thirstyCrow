...
class org::mpisws::p2p::transport::networkinfo::NetworkInfoTransportLayer_handleIdRequest_8
...
public:
    ...
    // Generated
    NetworkInfoTransportLayer_handleIdRequest_8(NetworkInfoTransportLayer *NetworkInfoTransportLayer_this, ::org::mpisws::p2p::transport::P2PSocket* socket);
