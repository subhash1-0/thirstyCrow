...
class org::mpisws::p2p::transport::liveness::PongMessage
...
public:
    ...
    // Generated
    PongMessage(int64_t sentTime);
    PongMessage(::rice::p2p::commonapi::rawserialization::InputBuffer* buf);
protected:
    PongMessage(const ::default_init_tag&);
