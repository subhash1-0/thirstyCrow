...
class org::mpisws::p2p::transport::liveness::LivenessTransportLayerImpl_pong_4
...
public:
    ...
    // Generated
    LivenessTransportLayerImpl_pong_4(LivenessTransportLayerImpl *LivenessTransportLayerImpl_this, ::java::lang::Object* i, int64_t senderTime, ::java::util::Map* options);
