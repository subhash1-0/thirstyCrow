...
class org::mpisws::p2p::transport::liveness::LivenessTransportLayerImpl_openSocket_1
...
public:
    ...
    // Generated
    LivenessTransportLayerImpl_openSocket_1(LivenessTransportLayerImpl *LivenessTransportLayerImpl_this, ::org::mpisws::p2p::transport::SocketCallback* deliverSocketToMe, ::java::lang::Object* i, ::java::util::Map* options);
