...
class org::mpisws::p2p::transport::priority::PriorityTransportLayerImpl_EntityManager_handleBigMsgSocket_5
...
public:
    ...
    // Generated
    PriorityTransportLayerImpl_EntityManager_handleBigMsgSocket_5(PriorityTransportLayerImpl_EntityManager *PriorityTransportLayerImpl_EntityManager_this);
