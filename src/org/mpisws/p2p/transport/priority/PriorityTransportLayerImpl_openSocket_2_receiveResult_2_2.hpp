...
class org::mpisws::p2p::transport::priority::PriorityTransportLayerImpl_openSocket_2_receiveResult_2_2
...
public:
    ...
    // Generated
    PriorityTransportLayerImpl_openSocket_2_receiveResult_2_2(PriorityTransportLayerImpl_openSocket_2 *PriorityTransportLayerImpl_openSocket_2_this, ::org::mpisws::p2p::transport::SocketCallback* deliverSocketToMe, ::org::mpisws::p2p::transport::util::SocketRequestHandleImpl* handle);
    static ::java::lang::Class *class_();
    PriorityTransportLayerImpl_openSocket_2 *PriorityTransportLayerImpl_openSocket_2_this;
