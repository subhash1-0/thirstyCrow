...
class org::mpisws::p2p::transport::priority::PriorityTransportLayerImpl_destroy_4
...
public:
    ...
    // Generated
    PriorityTransportLayerImpl_destroy_4(PriorityTransportLayerImpl *PriorityTransportLayerImpl_this);
