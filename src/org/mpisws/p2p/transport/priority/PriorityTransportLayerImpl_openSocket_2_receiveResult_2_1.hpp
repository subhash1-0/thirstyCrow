...
class org::mpisws::p2p::transport::priority::PriorityTransportLayerImpl_openSocket_2_receiveResult_2_1
...
public:
    ...
    // Generated
    PriorityTransportLayerImpl_openSocket_2_receiveResult_2_1(PriorityTransportLayerImpl_openSocket_2 *PriorityTransportLayerImpl_openSocket_2_this, ::org::mpisws::p2p::transport::P2PSocket* sock);
