...
class org::mpisws::p2p::transport::priority::PriorityTransportLayerImpl_EntityManager_send_6
...
public:
    ...
    // Generated
    PriorityTransportLayerImpl_EntityManager_send_6(PriorityTransportLayerImpl_EntityManager *PriorityTransportLayerImpl_EntityManager_this);
