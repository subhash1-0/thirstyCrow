...
org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::ReplaySocket(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::ReplaySocket(::rice::p2p::commonapi::rawserialization::RawSerializable* identifier, int32_t socketId, VerifierImpl* verifier, ::java::util::Map* options) 
    : ReplaySocket(*static_cast< ::default_init_tag* >(0))
{
    ctor(identifier,socketId,verifier,options);
}

void org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::init()
{
    closed = false;
    outputShutdown = false;
}

void org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::ctor(::rice::p2p::commonapi::rawserialization::RawSerializable* identifier, int32_t socketId, VerifierImpl* verifier, ::java::util::Map* options)
{
    super::ctor();
    init();
...
rice::p2p::commonapi::rawserialization::RawSerializable* org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::getIdentifier()
{
    return java_cast< ::rice::p2p::commonapi::rawserialization::RawSerializable* >(identifier);
}

java::util::Map* org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::getOptions()
{
    return options;
}

int64_t org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::read(::java::nio::ByteBuffer* dst) /* throws(IOException) */
{
    return npc(verifier)->readSocket(socketId, dst);
}

int64_t org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::write(::java::nio::ByteBuffer* src) /* throws(IOException) */
{
    return npc(verifier)->writeSocket(socketId, src);
}

void org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::register_(bool wantToRead, bool wantToWrite, ::org::mpisws::p2p::transport::P2PSocketReceiver* receiver)
{
    if(closed) {
...
void org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::notifyIO(bool canRead, bool canWrite) /* throws(IOException) */
{
    if(!canRead && !canWrite) {
...
void org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::close()
{
    closed = true;
    npc(verifier)->close(socketId);
}

void org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::setDeliverSocketToMe(::org::mpisws::p2p::transport::SocketCallback* deliverSocketToMe)
{
    this->deliverSocketToMe = deliverSocketToMe;
}

void org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::socketOpened()
{
    npc(deliverSocketToMe)->receiveResult(this, this);
    deliverSocketToMe = nullptr;
}

void org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::shutdownOutput()
{
    outputShutdown = true;
    npc(verifier)->shutdownOutput(socketId);
}

void org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::receiveException(::java::io::IOException* ioe)
{
...
bool org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::cancel()
{
...
java::lang::Class* org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::class_()
{
    static ::java::lang::Class* c = ::class_(u"org.mpisws.p2p.transport.peerreview.replay.ReplaySocket", 55);
    return c;
}

java::lang::Class* org::mpisws::p2p::transport::peerreview::replay::ReplaySocket::getClass0()
{
    return class_();
}
