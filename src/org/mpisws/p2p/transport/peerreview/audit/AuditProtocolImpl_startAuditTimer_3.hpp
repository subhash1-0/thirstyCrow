...
class org::mpisws::p2p::transport::peerreview::audit::AuditProtocolImpl_startAuditTimer_3
...
public:
    ...
    // Generated
    AuditProtocolImpl_startAuditTimer_3(AuditProtocolImpl *AuditProtocolImpl_this);
