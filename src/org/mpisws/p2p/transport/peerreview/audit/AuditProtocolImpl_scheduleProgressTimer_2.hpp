...
class org::mpisws::p2p::transport::peerreview::audit::AuditProtocolImpl_scheduleProgressTimer_2
...
public:
    ...
    // Generated
    AuditProtocolImpl_scheduleProgressTimer_2(AuditProtocolImpl *AuditProtocolImpl_this);
