...
class org::mpisws::p2p::transport::peerreview::audit::AuditProtocolImpl_AuditProtocolImpl_1
...
public:
    ...
    // Generated
    AuditProtocolImpl_AuditProtocolImpl_1(AuditProtocolImpl *AuditProtocolImpl_this);
