...
class org::mpisws::p2p::transport::identity::IdentityImpl_LowerIdentityImpl_openSocket_1_receiveResult_1_2_receiveSelectResult_1_2_1
...
public: /* package */
    ::java::nio::ByteBuffer* responseBuffer {  };
