...
class org::mpisws::p2p::transport::identity::IdentityImpl_LowerIdentityImpl_incomingSocket_2_receiveSelectResult_2_1
...
public:
    ...
    // Generated
    IdentityImpl_LowerIdentityImpl_incomingSocket_2_receiveSelectResult_2_1(IdentityImpl_LowerIdentityImpl_incomingSocket_2 *IdentityImpl_LowerIdentityImpl_incomingSocket_2_this, bool wantsToVerify);
    static ::java::lang::Class *class_();

private:
    void init();
    IdentityImpl_LowerIdentityImpl_incomingSocket_2 *IdentityImpl_LowerIdentityImpl_incomingSocket_2_this;
    bool wantsToVerify;
