...
class org::mpisws::p2p::transport::table::TableTransprotLayerImpl_handleValueRequest_4
...
public:
    ...
    // Generated
    TableTransprotLayerImpl_handleValueRequest_4(TableTransprotLayerImpl *TableTransprotLayerImpl_this, ::org::mpisws::p2p::transport::P2PSocket* sock);
