...
class org::mpisws::p2p::transport::ssl::SSLTransportLayerImpl_incomingSocket_2
...
public:
    ...
    // Generated
    SSLTransportLayerImpl_incomingSocket_2(SSLTransportLayerImpl *SSLTransportLayerImpl_this, ::org::mpisws::p2p::transport::P2PSocket* s);
