...
class org::mpisws::p2p::transport::sourceroute::factory::MultiAddressSourceRouteFactory
...
public:
    ...
    virtual ::org::mpisws::p2p::transport::sourceroute::SourceRoute* build(::rice::p2p::commonapi::rawserialization::InputBuffer* buf, ::org::mpisws::p2p::transport::multiaddress::MultiInetSocketAddress* local, ::org::mpisws::p2p::transport::multiaddress::MultiInetSocketAddress* lastHop) /* throws(IOException) */;
    ...
    virtual ::org::mpisws::p2p::transport::sourceroute::SourceRoute* getSourceRoute(::org::mpisws::p2p::transport::multiaddress::MultiInetSocketAddress* local, ::org::mpisws::p2p::transport::multiaddress::MultiInetSocketAddress* dest);
    virtual ::org::mpisws::p2p::transport::sourceroute::SourceRoute* getSourceRoute(::org::mpisws::p2p::transport::multiaddress::MultiInetSocketAddress* local);

    // Generated
    MultiAddressSourceRouteFactory();
protected:
    MultiAddressSourceRouteFactory(const ::default_init_tag&);
