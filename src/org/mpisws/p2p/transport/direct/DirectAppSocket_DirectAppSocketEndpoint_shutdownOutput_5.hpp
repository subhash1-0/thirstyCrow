...
class org::mpisws::p2p::transport::direct::DirectAppSocket_DirectAppSocketEndpoint_shutdownOutput_5
...
public:
    ...
    // Generated
    DirectAppSocket_DirectAppSocketEndpoint_shutdownOutput_5(DirectAppSocket_DirectAppSocketEndpoint *DirectAppSocket_DirectAppSocketEndpoint_this);
