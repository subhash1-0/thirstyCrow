...
class org::mpisws::p2p::transport::direct::DirectAppSocket_AcceptorDelivery
...
public:
    ...
    // Generated
    DirectAppSocket_AcceptorDelivery(DirectAppSocket *DirectAppSocket_this);
protected:
    DirectAppSocket_AcceptorDelivery(DirectAppSocket *DirectAppSocket_this, const ::default_init_tag&);
