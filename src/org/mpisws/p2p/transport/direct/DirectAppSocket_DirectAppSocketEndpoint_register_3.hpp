...
class org::mpisws::p2p::transport::direct::DirectAppSocket_DirectAppSocketEndpoint_register_3
...
public:
    ...
    // Generated
    DirectAppSocket_DirectAppSocketEndpoint_register_3(DirectAppSocket_DirectAppSocketEndpoint *DirectAppSocket_DirectAppSocketEndpoint_this);
