...
class org::mpisws::p2p::transport::direct::DirectAppSocket_DirectAppSocketEndpoint_register_4
...
public:
    ...
    // Generated
    DirectAppSocket_DirectAppSocketEndpoint_register_4(DirectAppSocket_DirectAppSocketEndpoint *DirectAppSocket_DirectAppSocketEndpoint_this);
