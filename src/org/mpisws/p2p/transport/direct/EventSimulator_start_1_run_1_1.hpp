...
class org::mpisws::p2p::transport::direct::EventSimulator_start_1_run_1_1
...
public:
    ...
    // Generated
    EventSimulator_start_1_run_1_1(EventSimulator_start_1 *EventSimulator_start_1_this);
    static ::java::lang::Class *class_();
    EventSimulator_start_1 *EventSimulator_start_1_this;
