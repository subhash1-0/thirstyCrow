...
class org::mpisws::p2p::filetransfer::FileTransferImpl_FileReceiptImpl_scheduleClose_3
...
public:
    ...
    // Generated
    FileTransferImpl_FileReceiptImpl_scheduleClose_3(FileTransferImpl_FileReceiptImpl *FileTransferImpl_FileReceiptImpl_this);
