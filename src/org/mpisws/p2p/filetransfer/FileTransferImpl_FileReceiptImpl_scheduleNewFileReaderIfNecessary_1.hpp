...
class org::mpisws::p2p::filetransfer::FileTransferImpl_FileReceiptImpl_scheduleNewFileReaderIfNecessary_1
...
public:
    ...
    // Generated
    FileTransferImpl_FileReceiptImpl_scheduleNewFileReaderIfNecessary_1(FileTransferImpl_FileReceiptImpl *FileTransferImpl_FileReceiptImpl_this);
