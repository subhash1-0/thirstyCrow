...
class org::mpisws::p2p::filetransfer::FileTransferImpl_FileHeaderReader
...
public:
    ...
    // Generated
    FileTransferImpl_FileHeaderReader(FileTransferImpl *FileTransferImpl_this);
protected:
    void ctor();
    FileTransferImpl_FileHeaderReader(FileTransferImpl *FileTransferImpl_this, const ::default_init_tag&);
