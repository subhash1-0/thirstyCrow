...
class org::mpisws::p2p::filetransfer::FileTransferImpl_FileDataReader_completeChunk_1
...
public:
    ...
    virtual void receiveResult(::java::lang::Long* myPtrL);
    void receiveException(::java::lang::Exception* exception) override;

    // Generated
    FileTransferImpl_FileDataReader_completeChunk_1(FileTransferImpl_FileDataReader *FileTransferImpl_FileDataReader_this);
