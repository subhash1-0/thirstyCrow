...
class org::mpisws::p2p::filetransfer::FileTransferImpl_MsgTypeReader
...
public:
    ...
    // Generated
    FileTransferImpl_MsgTypeReader(FileTransferImpl *FileTransferImpl_this);
protected:
    void ctor();
    FileTransferImpl_MsgTypeReader(FileTransferImpl *FileTransferImpl_this, const ::default_init_tag&);
