...
class org::mpisws::p2p::filetransfer::FileTransferImpl_FileDataReader_cancelled_3
...
public:
    ...
    virtual void receiveResult(::java::io::RandomAccessFile* result);
    void receiveException(::java::lang::Exception* exception) override;

    // Generated
    FileTransferImpl_FileDataReader_cancelled_3(FileTransferImpl_FileDataReader *FileTransferImpl_FileDataReader_this, FileTransferImpl_DataReader* reader);
    ...
    FileTransferImpl_DataReader* reader;
