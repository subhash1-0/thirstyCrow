...
class org::mpisws::p2p::filetransfer::FileTransferImpl_FileReceiptImpl_scheduleClose_4
...
public:
    ...
    // Generated
    FileTransferImpl_FileReceiptImpl_scheduleClose_4(FileTransferImpl_FileReceiptImpl *FileTransferImpl_FileReceiptImpl_this, ::rice::Continuation* c, ::rice::selector::SelectorManager* sm);
    FileTransferImpl_FileReceiptImpl_scheduleClose_4(FileTransferImpl_FileReceiptImpl *FileTransferImpl_FileReceiptImpl_this);
