...
class org::mpisws::p2p::filetransfer::FileTransferImpl_FileDataReader_cancelled_4
    : public ::rice::environment::processing::WorkRequest
{

public:
    typedef ::rice::environment::processing::WorkRequest super;
    ::java::io::RandomAccessFile* doWork() /* throws(Exception) */ override;

    // Generated
    FileTransferImpl_FileDataReader_cancelled_4(FileTransferImpl_FileDataReader *FileTransferImpl_FileDataReader_this, ::rice::Continuation* c, ::rice::selector::SelectorManager* sm);
    FileTransferImpl_FileDataReader_cancelled_4(FileTransferImpl_FileDataReader *FileTransferImpl_FileDataReader_this);
