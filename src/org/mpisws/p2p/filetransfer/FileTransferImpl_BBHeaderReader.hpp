...
class org::mpisws::p2p::filetransfer::FileTransferImpl_BBHeaderReader
...
public:
    ...
    // Generated
    FileTransferImpl_BBHeaderReader(FileTransferImpl *FileTransferImpl_this);
protected:
    void ctor();
    FileTransferImpl_BBHeaderReader(FileTransferImpl *FileTransferImpl_this, const ::default_init_tag&);
