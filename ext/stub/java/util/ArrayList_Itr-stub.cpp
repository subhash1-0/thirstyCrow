...
void java::util::ArrayList_Itr::forEachRemaining(::java::util::function::Consumer* arg0)
{ /* stub */
    unimplemented_(u"void java::util::ArrayList_Itr::forEachRemaining(::java::util::function::Consumer* arg0)");
}
