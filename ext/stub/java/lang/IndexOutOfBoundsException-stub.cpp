...
java::lang::IndexOutOfBoundsException::IndexOutOfBoundsException(String* arg0)
    : IndexOutOfBoundsException(*static_cast< ::default_init_tag* >(0))
{
    ctor(arg0);
}
...
void ::java::lang::IndexOutOfBoundsException::ctor(String* arg0)
{ /* stub */
    /* super::ctor(); */
    unimplemented_(u"void ::java::lang::IndexOutOfBoundsException::ctor(String* arg0)");
}
