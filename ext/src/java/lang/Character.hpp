...
public:
    static int32_t compare(char16_t arg0, char16_t arg1);
    ...
    static String* getName(int32_t arg0);
    ...
    static int32_t hashCode(char16_t arg0);
    static char16_t highSurrogate(int32_t arg0);
    static bool isAlphabetic(int32_t arg0);
    static bool isBmpCodePoint(int32_t arg0);
    ...
    static bool isIdeographic(int32_t arg0);
    ...
    static bool isSurrogate(char16_t arg0);
    ...
    static char16_t lowSurrogate(int32_t arg0);
...
public: /* package */
    static ::char16_tArray* toUpperCaseCharArray_(int32_t arg0);
